...
exports.default = (0, config_1.defineConfig)(__assign(__assign({}, vitest_config_ts_1.default), { test: __assign(__assign({}, baseTest), { include: ["src/gateway/**/*.test.ts"], exclude: exclude }) }));
