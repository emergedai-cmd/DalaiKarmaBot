...
exports.resolveMediaMaxBytes = resolveMediaMaxBytes;
exports.resolveMatrixClient = resolveMatrixClient;
...
function resolveMediaMaxBytes() {
    var _a, _b;
    var cfg = getCore().config.loadConfig();
    if (typeof ((_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.matrix) === null || _b === void 0 ? void 0 : _b.mediaMaxMb) === "number") {
        return cfg.channels.matrix.mediaMaxMb * 1024 * 1024;
    }
    return undefined;
}
function resolveMatrixClient(opts) {
