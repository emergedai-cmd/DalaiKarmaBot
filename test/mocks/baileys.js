...
function createMockBaileys() {
    var _this = this;
    var sockets = [];
    var makeWASocket = vitest_1.vi.fn(function (_opts) {
        ...
        setImmediate(function () { return ev.emit("connection.update", { connection: "open" }); });
        sockets.push(sock);
        return sock;
    });
    var mod = {
        ...
        makeCacheableSignalKeyStore: vitest_1.vi.fn(function (keys) { return keys; }),
        makeWASocket: makeWASocket,
        useMultiFileAuthState: vitest_1.vi.fn(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        jidToE164: function (jid) { return jid.replace(/@.*$/, "").replace(/^/, "+"); },
        downloadMediaMessage: vitest_1.vi.fn().mockResolvedValue(Buffer.from("img")),
    };
    return {
        mod: mod,
        lastSocket: function () {
            var last = sockets.at(-1);
            if (!last) {
