...
var FALLBACK = (_a = TOOL_DISPLAY_CONFIG.fallback) !== null && _a !== void 0 ? _a : { icon: "puzzle" };
...
function resolveToolDisplay(params) {
    ...
    var icon = ((_b = (_a = spec === null || spec === void 0 ? void 0 : spec.icon) !== null && _a !== void 0 ? _a : FALLBACK.icon) !== null && _b !== void 0 ? _b : "puzzle");
    var title = (_c = spec === null || spec === void 0 ? void 0 : spec.title) !== null && _c !== void 0 ? _c : defaultTitle(name);
    var label = (_d = spec === null || spec === void 0 ? void 0 : spec.label) !== null && _d !== void 0 ? _d : name;
...
function formatToolSummary(display) {
    ...
    return detail ? "".concat(display.label, ": ").concat(detail) : display.label;
}
