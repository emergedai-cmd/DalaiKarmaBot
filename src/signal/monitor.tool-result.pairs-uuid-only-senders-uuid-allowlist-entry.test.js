...
(0, vitest_1.describe)("monitorSignalProvider tool results", function () {
    (0, vitest_1.it)("pairs uuid-only senders with a uuid allowlist entry", function () { return __awaiter(void 0, void 0, void 0, function () {
        var abortController, uuid;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    (0, vitest_1.expect)(upsertPairingRequestMock).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
                        channel: "signal",
                        id: "uuid:".concat(uuid),
                        meta: vitest_1.expect.objectContaining({ name: "Ada" }),
                    }));
                    (0, vitest_1.expect)(sendMock).toHaveBeenCalledTimes(1);
                    (0, vitest_1.expect)((_b = sendMock.mock.calls[0]) === null || _b === void 0 ? void 0 : _b[0]).toBe("signal:".concat(uuid));
                    (0, vitest_1.expect)(String((_d = (_c = sendMock.mock.calls[0]) === null || _c === void 0 ? void 0 : _c[1]) !== null && _d !== void 0 ? _d : "")).toContain("Your Signal sender id: uuid:".concat(uuid));
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("reconnects after stream errors until aborted", function () { return __awaiter(void 0, void 0, void 0, function () {
        var abortController, randomSpy, calls, monitorPromise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, , 4, 5]);
                    monitorPromise = (0, monitor_js_1.monitorSignalProvider)({
                        autoStart: false,
                        baseUrl: "http://127.0.0.1:8080",
                        abortSignal: abortController.signal,
                    });
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, monitorPromise];
                case 3:
                    _a.sent();
                    (0, vitest_1.expect)(streamMock).toHaveBeenCalledTimes(2);
                    return [3 /*break*/, 5];
                case 4:
