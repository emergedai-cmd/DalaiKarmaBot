...
function applyInsertionsToStyles(spans, insertions) {
    ...
    var sortedInsertions = __spreadArray([], insertions, true).toSorted(function (a, b) { return a.pos - b.pos; });
    var updated = spans;
...
function renderSignalText(ir) {
    ...
    var sortedLinks = __spreadArray([], ir.links, true).toSorted(function (a, b) { return a.start - b.start; });
    var out = "";
    var cursor = 0;
    var insertions = [];
