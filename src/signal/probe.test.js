...
(0, vitest_1.describe)("probeSignal", function () {
    (0, vitest_1.beforeEach)(function () {
        vitest_1.vi.clearAllMocks();
    });
    (0, vitest_1.it)("extracts version from {version} result", function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, probe_js_1.probeSignal)("http://127.0.0.1:8080", 1000)];
                case 1:
                    res = _a.sent();
                    (0, vitest_1.expect)(res.ok).toBe(true);
                    (0, vitest_1.expect)(res.version).toBe("0.13.22");
                    (0, vitest_1.expect)(res.status).toBe(200);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("returns ok=false when /check fails", function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(res.version).toBe(null);
                    return [2 /*return*/];
            }
        });
    }); });
