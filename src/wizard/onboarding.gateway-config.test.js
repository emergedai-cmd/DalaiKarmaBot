...
(0, vitest_1.describe)("configureGatewayForOnboarding", function () {
    (0, vitest_1.it)("generates a token when the prompt returns undefined", function () { return __awaiter(void 0, void 0, void 0, function () {
        var selectQueue, textQueue, prompter, runtime, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    result = _a.sent();
                    (0, vitest_1.expect)(result.settings.gatewayToken).toBe("generated-token");
                    return [2 /*return*/];
            }
        });
    }); });
