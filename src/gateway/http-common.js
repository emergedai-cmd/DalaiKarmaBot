...
exports.sendInvalidRequest = sendInvalidRequest;
exports.readJsonBodyOrError = readJsonBodyOrError;
...
function readJsonBodyOrError(req, res, maxBytes) {
    return __awaiter(this, void 0, void 0, function () {
        var body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, hooks_js_1.readJsonBody)(req, maxBytes)];
                case 1:
                    body = _a.sent();
                    if (!body.ok) {
