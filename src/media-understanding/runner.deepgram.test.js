...
(0, vitest_1.describe)("runCapability deepgram provider options", function () {
    (0, vitest_1.it)("merges provider options, headers, and baseUrl overrides", function () { return __awaiter(void 0, void 0, void 0, function () {
        var tmpPath, ctx, media, cache, seenQuery, seenBaseUrl, seenHeaders, providerRegistry, cfg, result;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    tmpPath = node_path_1.default.join(node_os_1.default.tmpdir(), "openclaw-deepgram-".concat(Date.now(), ".wav"));
                ...
                case 3:
                    ...
                    (0, vitest_1.expect)(seenBaseUrl).toBe("https://entry.example");
                    (0, vitest_1.expect)(seenHeaders).toMatchObject({
                        "X-Provider": "1",
                        "X-Config": "2",
                        "X-Entry": "3",
                    });
                    (0, vitest_1.expect)(seenQuery).toMatchObject({
                        detect_language: false,
                        punctuate: false,
                        smart_format: true,
                    });
                    (0, vitest_1.expect)(seenQuery["detectLanguage"]).toBeUndefined();
                    return [3 /*break*/, 7];
