...
function transcribeDeepgramAudio(params) {
    return __awaiter(this, void 0, void 0, function () {
        var fetchFn, baseUrl, allowPrivate, model, url, _i, _a, _b, key, value, headers, body, _c, res, release, detail, suffix, payload, transcript;
        var _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
        return __generator(this, function (_p) {
            switch (_p.label) {
                case 0:
                    fetchFn = (_d = params.fetchFn) !== null && _d !== void 0 ? _d : fetch;
                    baseUrl = (0, shared_js_1.normalizeBaseUrl)(params.baseUrl, exports.DEFAULT_DEEPGRAM_AUDIO_BASE_URL);
                    allowPrivate = Boolean((_e = params.baseUrl) === null || _e === void 0 ? void 0 : _e.trim());
                    model = resolveModel(params.model);
                    url = new URL("".concat(baseUrl, "/listen"));
                    url.searchParams.set("model", model);
                    if ((_f = params.language) === null || _f === void 0 ? void 0 : _f.trim()) {
                    ...
                    if (!headers.has("content-type")) {
                        headers.set("content-type", (_g = params.mime) !== null && _g !== void 0 ? _g : "application/octet-stream");
                    }
                    body = new Uint8Array(params.buffer);
                    return [4 /*yield*/, (0, shared_js_1.fetchWithTimeoutGuarded)(url.toString(), {
                            method: "POST",
                            headers: headers,
                            body: body,
                        }, params.timeoutMs, fetchFn, allowPrivate ? { ssrfPolicy: { allowPrivateNetwork: true } } : undefined)];
                case 1:
                    _c = _p.sent(), res = _c.response, release = _c.release;
                    _p.label = 2;
                case 2:
                    _p.trys.push([2, , 6, 8]);
                ...
                case 5:
                    payload = (_p.sent());
                    transcript = (_o = (_m = (_l = (_k = (_j = (_h = payload.results) === null || _h === void 0 ? void 0 : _h.channels) === null || _j === void 0 ? void 0 : _j[0]) === null || _k === void 0 ? void 0 : _k.alternatives) === null || _l === void 0 ? void 0 : _l[0]) === null || _m === void 0 ? void 0 : _m.transcript) === null || _o === void 0 ? void 0 : _o.trim();
                    if (!transcript) {
