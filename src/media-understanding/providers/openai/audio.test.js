...
(0, vitest_1.describe)("transcribeOpenAiCompatibleAudio", function () {
    ...
    (0, vitest_1.it)("respects lowercase authorization header overrides", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fetchFn = function (_input, init) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            return [2 /*return*/, new Response(JSON.stringify({ text: "ok" }), {
                                    status: 200,
                                    headers: { "content-type": "application/json" },
                                })];
                        });
                    }); };
                    return [4 /*yield*/, (0, audio_js_1.transcribeOpenAiCompatibleAudio)({
                ...
                case 1:
                    result = _a.sent();
                    (0, vitest_1.expect)(seenAuth).toBe("Bearer override");
    ...
    (0, vitest_1.it)("builds the expected request payload", function () { return __awaiter(void 0, void 0, void 0, function () {
        var seenUrl, seenInit, fetchFn, result, headers, form, file;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    seenUrl = null;
                    fetchFn = function (input, init) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            ...
                            seenInit = init;
                            return [2 /*return*/, new Response(JSON.stringify({ text: "hello" }), {
                                    status: 200,
                                    headers: { "content-type": "application/json" },
                                })];
                        });
                ...
                case 1:
                    result = _a.sent();
                    (0, vitest_1.expect)(result.model).toBe("gpt-4o-mini-transcribe");
                    (0, vitest_1.expect)(result.text).toBe("hello");
                    (0, vitest_1.expect)(seenUrl).toBe("https://api.example.com/v1/audio/transcriptions");
                    ...
                    (0, vitest_1.expect)(headers.get("authorization")).toBe("Bearer test-key");
                    (0, vitest_1.expect)(headers.get("x-custom")).toBe("1");
                    form = seenInit === null || seenInit === void 0 ? void 0 : seenInit.body;
                    (0, vitest_1.expect)(form).toBeInstanceOf(FormData);
                    (0, vitest_1.expect)(form.get("model")).toBe("gpt-4o-mini-transcribe");
                    (0, vitest_1.expect)(form.get("language")).toBe("en");
                    (0, vitest_1.expect)(form.get("prompt")).toBe("hello");
                    file = form.get("file");
                    (0, vitest_1.expect)(file).not.toBeNull();
                    if (file) {
                        (0, vitest_1.expect)(file.type).toBe("audio/wav");
                        if ("name" in file && typeof file.name === "string") {
                            (0, vitest_1.expect)(file.name).toBe("voice.wav");
                        }
                    }
                    return [2 /*return*/];
            }
