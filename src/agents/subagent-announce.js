...
function runSubagentAnnounceFlow(params) {
    return __awaiter(this, void 0, void 0, function () {
        var didAnnounce, requesterOrigin, reply, outcome, waitMs, wait, waitError, statsLine, statusLabel, taskLabel, triggerMessage, queued, directOrigin, entry, err_1, _a, _b;
        var _c;
