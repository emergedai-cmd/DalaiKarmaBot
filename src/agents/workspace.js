...
function loadTemplate(name) {
    return __awaiter(this, void 0, void 0, function () {
        var templateDir, templatePath, content, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, workspace_templates_js_1.resolveWorkspaceTemplateDir)()];
                case 1:
                    templateDir = _b.sent();
                    templatePath = node_path_1.default.join(templateDir, name);
                    _b.label = 2;
                case 2:
                    _b.trys.push([2, 4, , 5]);
