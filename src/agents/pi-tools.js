...
function createOpenClawCodingTools(options) {
    ...
    var withHooks = normalized.map(function (tool) {
        return (0, pi_tools_before_tool_call_js_1.wrapToolWithBeforeToolCallHook)(tool, {
            agentId: agentId,
            sessionKey: options === null || options === void 0 ? void 0 : options.sessionKey,
        });
    });
    var withAbort = (options === null || options === void 0 ? void 0 : options.abortSignal)
        ? withHooks.map(function (tool) { return (0, pi_tools_abort_js_1.wrapToolWithAbortSignal)(tool, options.abortSignal); })
        : withHooks;
