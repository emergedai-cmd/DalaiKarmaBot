...
(0, vitest_1.describe)("applyGoogleTurnOrderingFix", function () {
    var makeAssistantFirst = function () {
        return [
            {
                role: "assistant",
    ...
    (0, vitest_1.it)("prepends a bootstrap once and records a marker for Google models", function () {
        var _a, _b;
        var sessionManager = pi_coding_agent_1.SessionManager.inMemory();
        var warn = vitest_1.vi.fn();
        var input = makeAssistantFirst();
        var first = (0, pi_embedded_runner_js_1.applyGoogleTurnOrderingFix)({
            messages: input,
        ...
        (0, vitest_1.expect)((_a = first.messages[0]) === null || _a === void 0 ? void 0 : _a.role).toBe("user");
        (0, vitest_1.expect)((_b = first.messages[1]) === null || _b === void 0 ? void 0 : _b.role).toBe("assistant");
        (0, vitest_1.expect)(warn).toHaveBeenCalledTimes(1);
        (0, vitest_1.expect)(sessionManager
            .getEntries()
            .some(function (entry) {
            return entry.type === "custom" && entry.customType === "google-turn-ordering-bootstrap";
        })).toBe(true);
        (0, pi_embedded_runner_js_1.applyGoogleTurnOrderingFix)({
            messages: input,
            modelApi: "google-generative-ai",
            sessionManager: sessionManager,
            sessionId: "session:1",
    ...
    (0, vitest_1.it)("skips non-Google models", function () {
        var sessionManager = pi_coding_agent_1.SessionManager.inMemory();
        var warn = vitest_1.vi.fn();
        var input = makeAssistantFirst();
        var result = (0, pi_embedded_runner_js_1.applyGoogleTurnOrderingFix)({
            messages: input,
            modelApi: "openai",
            sessionManager: sessionManager,
            sessionId: "session:2",
        ...
        (0, vitest_1.expect)(result.messages).toBe(input);
