...
(0, vitest_1.describe)("buildWorkspaceSkillsPrompt", function () {
    (0, vitest_1.it)("applies bundled allowlist without affecting workspace skills", function () { return __awaiter(void 0, void 0, void 0, function () {
        var workspaceDir, bundledDir, bundledSkillDir, workspaceSkillDir, prompt;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    (0, vitest_1.expect)(prompt).not.toContain("peekaboo");
                    return [2 /*return*/];
            }
        });
    }); });
