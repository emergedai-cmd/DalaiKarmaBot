...
(0, vitest_1.describe)("splitSdkTools", function () {
    var tools = [
        createStubTool("read"),
        createStubTool("exec"),
        createStubTool("edit"),
    ...
    (0, vitest_1.it)("routes all tools to customTools when sandboxed", function () {
        var _a = (0, pi_embedded_runner_js_1.splitSdkTools)({
            tools: tools,
            sandboxEnabled: true,
        }), builtInTools = _a.builtInTools, customTools = _a.customTools;
        (0, vitest_1.expect)(builtInTools).toEqual([]);
        (0, vitest_1.expect)(customTools.map(function (tool) { return tool.name; })).toEqual([
            "read",
            "exec",
            "edit",
            "write",
    ...
    (0, vitest_1.it)("routes all tools to customTools even when not sandboxed", function () {
        var _a = (0, pi_embedded_runner_js_1.splitSdkTools)({
            tools: tools,
