...
(0, vitest_1.describe)("models-config", function () {
    ...
    (0, vitest_1.it)("falls back to default baseUrl when token exchange fails", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                            ...
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    vitest_1.vi.doMock("../providers/github-copilot-token.js", function () { return ({
                                        ...
                                        resolveCopilotApiToken: vitest_1.vi.fn().mockRejectedValue(new Error("boom")),
                                    }); });
                                ...
                                case 5:
                                    ...
                                    (0, vitest_1.expect)((_a = parsed.providers["github-copilot"]) === null || _a === void 0 ? void 0 : _a.baseUrl).toBe("https://api.default.test");
                                    return [3 /*break*/, 7];
                                case 6:
    ...
    (0, vitest_1.it)("uses agentDir override auth profiles for copilot injection", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var previous, previousGh, previousGithub, agentDir, ensureOpenClawModelsJson, raw, parsed;
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                ...
                                case 1:
                                    _b.trys.push([1, , 7, 8]);
                                    vitest_1.vi.resetModules();
                                    agentDir = node_path_1.default.join(home, "agent-override");
