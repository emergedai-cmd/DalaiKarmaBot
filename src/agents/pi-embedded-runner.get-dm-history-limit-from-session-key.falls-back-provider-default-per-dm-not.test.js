...
(0, vitest_1.describe)("getDmHistoryLimitFromSessionKey", function () {
    (0, vitest_1.it)("falls back to provider default when per-DM not set", function () {
        var config = {
            channels: {
                telegram: {
                    dmHistoryLimit: 15,
    ...
    (0, vitest_1.it)("returns per-DM override for agent-prefixed keys", function () {
        var config = {
            channels: {
                telegram: {
                    dmHistoryLimit: 20,
        ...
        (0, vitest_1.expect)((0, pi_embedded_runner_js_1.getDmHistoryLimitFromSessionKey)("agent:main:telegram:dm:789", config)).toBe(3);
    });
    (0, vitest_1.it)("handles userId with colons (e.g., email)", function () {
        var config = {
            channels: {
                msteams: {
                    dmHistoryLimit: 10,
        ...
        (0, vitest_1.expect)((0, pi_embedded_runner_js_1.getDmHistoryLimitFromSessionKey)("msteams:dm:user@example.com", config)).toBe(7);
    });
    (0, vitest_1.it)("returns undefined when per-DM historyLimit is not set", function () {
        var config = {
            channels: {
                telegram: {
                    dms: { "123": {} },
    ...
    (0, vitest_1.it)("returns 0 when per-DM historyLimit is explicitly 0 (unlimited)", function () {
        var config = {
            channels: {
                telegram: {
                    dmHistoryLimit: 15,
        ...
        (0, vitest_1.expect)((0, pi_embedded_runner_js_1.getDmHistoryLimitFromSessionKey)("telegram:dm:123", config)).toBe(0);
    });
});
