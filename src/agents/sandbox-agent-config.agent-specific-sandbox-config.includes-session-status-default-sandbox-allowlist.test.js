...
(0, vitest_1.describe)("Agent-specific sandbox config", function () {
    ...
    (0, vitest_1.it)("includes session_status in default sandbox allowlist", function () { return __awaiter(void 0, void 0, void 0, function () {
        var resolveSandboxConfigForAgent, cfg, sandbox;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./sandbox.js"); })];
                case 1:
                    resolveSandboxConfigForAgent = (_a.sent()).resolveSandboxConfigForAgent;
                    cfg = {
                        agents: {
                            defaults: {
                                sandbox: {
                    ...
                    sandbox = resolveSandboxConfigForAgent(cfg, "main");
                    (0, vitest_1.expect)(sandbox.tools.allow).toContain("session_status");
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("includes image in default sandbox allowlist", function () { return __awaiter(void 0, void 0, void 0, function () {
        var resolveSandboxConfigForAgent, cfg, sandbox;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./sandbox.js"); })];
                case 1:
                    ...
                    sandbox = resolveSandboxConfigForAgent(cfg, "main");
                    (0, vitest_1.expect)(sandbox.tools.allow).toContain("image");
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("injects image into explicit sandbox allowlists", function () { return __awaiter(void 0, void 0, void 0, function () {
        var resolveSandboxConfigForAgent, cfg, sandbox;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./sandbox.js"); })];
