...
exports.readMiniMaxCliCredentialsCached = readMiniMaxCliCredentialsCached;
...
var MINIMAX_CLI_CREDENTIALS_RELATIVE_PATH = ".minimax/oauth_creds.json";
...
function resolveMiniMaxCliCredentialsPath(homeDir) {
    var baseDir = homeDir !== null && homeDir !== void 0 ? homeDir : (0, utils_js_1.resolveUserPath)("~");
    return node_path_1.default.join(baseDir, MINIMAX_CLI_CREDENTIALS_RELATIVE_PATH);
}
...
function readMiniMaxCliCredentials(options) {
    var credPath = resolveMiniMaxCliCredentialsPath(options === null || options === void 0 ? void 0 : options.homeDir);
    var raw = (0, json_file_js_1.loadJsonFile)(credPath);
    if (!raw || typeof raw !== "object") {
        return null;
    }
...
function readMiniMaxCliCredentialsCached(options) {
    ...
    var ttlMs = (_a = options === null || options === void 0 ? void 0 : options.ttlMs) !== null && _a !== void 0 ? _a : 0;
    var now = Date.now();
    var cacheKey = resolveMiniMaxCliCredentialsPath(options === null || options === void 0 ? void 0 : options.homeDir);
    if (ttlMs > 0 &&
        minimaxCliCache &&
    ...
    var value = readMiniMaxCliCredentials({ homeDir: options === null || options === void 0 ? void 0 : options.homeDir });
    if (ttlMs > 0) {
        minimaxCliCache = { value: value, readAt: now, cacheKey: cacheKey };
    }
    return value;
}
