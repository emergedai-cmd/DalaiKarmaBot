...
function subscribeEmbeddedPiSession(params) {
    ...
    var state = {
        ...
        partialBlockState: { thinking: false, final: false, inlineCode: (0, code_spans_js_1.createInlineCodeState)() },
    ...
    var partialReplyDirectiveAccumulator = (0, streaming_directives_js_1.createStreamingDirectiveAccumulator)();
    var resetAssistantMessageState = function (nextAssistantTextBaseline) {
        ...
        state.partialBlockState.inlineCode = (0, code_spans_js_1.createInlineCodeState)();
    ...
    var consumePartialReplyDirectives = function (text, options) {
        return partialReplyDirectiveAccumulator.consume(text, options);
    };
    ...
    var ctx = {
        ...
        consumePartialReplyDirectives: consumePartialReplyDirectives,
