...
(0, vitest_1.describe)("Agent-specific sandbox config", function () {
    ...
    (0, vitest_1.it)("should use global sandbox config when no agent-specific config exists", { timeout: 60000 }, function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)("should allow agent-specific docker setupCommand overrides", function () { return __awaiter(void 0, void 0, void 0, function () {
        var resolveSandboxContext, cfg, context;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./sandbox.js"); })];
                ...
                case 2:
                    context = _a.sent();
                    (0, vitest_1.expect)(context).toBeDefined();
                    (0, vitest_1.expect)(context === null || context === void 0 ? void 0 : context.docker.setupCommand).toBe("echo work");
                    (0, vitest_1.expect)(spawnCalls.some(function (call) {
    ...
    (0, vitest_1.it)("should ignore agent-specific docker overrides when scope is shared", function () { return __awaiter(void 0, void 0, void 0, function () {
        var resolveSandboxContext, cfg, context;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./sandbox.js"); })];
                ...
                case 2:
                    context = _a.sent();
                    (0, vitest_1.expect)(context).toBeDefined();
                    (0, vitest_1.expect)(context === null || context === void 0 ? void 0 : context.docker.setupCommand).toBe("echo global");
                    (0, vitest_1.expect)(context === null || context === void 0 ? void 0 : context.containerName).toContain("shared");
                    (0, vitest_1.expect)(spawnCalls.some(function (call) {
                        return call.command === "docker" &&
                            call.args[0] === "exec" &&
                            call.args.includes("-lc") &&
