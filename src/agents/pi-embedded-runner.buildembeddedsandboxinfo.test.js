...
(0, vitest_1.describe)("buildEmbeddedSandboxInfo", function () {
    (0, vitest_1.it)("returns undefined when sandbox is missing", function () {
        (0, vitest_1.expect)((0, pi_embedded_runner_js_1.buildEmbeddedSandboxInfo)()).toBeUndefined();
    });
    (0, vitest_1.it)("maps sandbox context into prompt info", function () {
        var sandbox = {
            enabled: true,
        ...
        (0, vitest_1.expect)((0, pi_embedded_runner_js_1.buildEmbeddedSandboxInfo)(sandbox)).toEqual({
            enabled: true,
            workspaceDir: "/tmp/openclaw-sandbox",
            workspaceAccess: "none",
    ...
    (0, vitest_1.it)("includes elevated info when allowed", function () {
        var sandbox = {
            enabled: true,
            sessionKey: "session:test",
            workspaceDir: "/tmp/openclaw-sandbox",
        ...
        (0, vitest_1.expect)((0, pi_embedded_runner_js_1.buildEmbeddedSandboxInfo)(sandbox, {
            enabled: true,
            allowed: true,
            defaultLevel: "on",
        })).toEqual({
