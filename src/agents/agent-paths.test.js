...
(0, vitest_1.describe)("resolveOpenClawAgentDir", function () {
    ...
    (0, vitest_1.it)("defaults to the multi-agent path when no overrides are set", function () { return __awaiter(void 0, void 0, void 0, function () {
        var resolved;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    delete process.env.OPENCLAW_AGENT_DIR;
                    delete process.env.PI_CODING_AGENT_DIR;
                    resolved = (0, agent_paths_js_1.resolveOpenClawAgentDir)();
                    (0, vitest_1.expect)(resolved).toBe(node_path_1.default.join(tempStateDir, "agents", "main", "agent"));
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("honors OPENCLAW_AGENT_DIR overrides", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    tempStateDir = _a.sent();
                    override = node_path_1.default.join(tempStateDir, "agent");
                    process.env.OPENCLAW_AGENT_DIR = override;
                    delete process.env.PI_CODING_AGENT_DIR;
                    resolved = (0, agent_paths_js_1.resolveOpenClawAgentDir)();
                    (0, vitest_1.expect)(resolved).toBe(node_path_1.default.resolve(override));
                    return [2 /*return*/];
            }
        });
    }); });
