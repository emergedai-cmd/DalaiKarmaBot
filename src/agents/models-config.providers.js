...
var MINIMAX_PORTAL_BASE_URL = "https://api.minimax.io/anthropic";
...
var MINIMAX_OAUTH_PLACEHOLDER = "minimax-oauth";
...
function resolveImplicitProviders(params) {
    return __awaiter(this, void 0, void 0, function () {
        var providers, authStore, minimaxKey, minimaxOauthProfile, moonshotKey, syntheticKey, veniceKey, _a, _b, qwenProfiles, xiaomiKey, ollamaKey, _c, _d;
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    ...
                    minimaxOauthProfile = (0, auth_profiles_js_1.listProfilesForProvider)(authStore, "minimax-portal");
                    if (minimaxOauthProfile.length > 0) {
                        providers["minimax-portal"] = __assign(__assign({}, buildMinimaxPortalProvider()), { apiKey: MINIMAX_OAUTH_PLACEHOLDER });
                    }
                    ...
                    syntheticKey = (_g = resolveEnvApiKeyVarName("synthetic")) !== null && _g !== void 0 ? _g : resolveApiKeyFromProfiles({ provider: "synthetic", store: authStore });
                    if (syntheticKey) {
                        providers.synthetic = __assign(__assign({}, buildSyntheticProvider()), { apiKey: syntheticKey });
                    }
                    veniceKey = (_h = resolveEnvApiKeyVarName("venice")) !== null && _h !== void 0 ? _h : resolveApiKeyFromProfiles({ provider: "venice", store: authStore });
                    if (!veniceKey) return [3 /*break*/, 2];
                    _a = providers;
                    _b = [{}];
                    return [4 /*yield*/, buildVeniceProvider()];
                case 1:
                    _a.venice = __assign.apply(void 0, [__assign.apply(void 0, _b.concat([(_l.sent())])), { apiKey: veniceKey }]);
                    _l.label = 2;
                case 2:
                    ...
                    xiaomiKey = (_j = resolveEnvApiKeyVarName("xiaomi")) !== null && _j !== void 0 ? _j : resolveApiKeyFromProfiles({ provider: "xiaomi", store: authStore });
                    if (xiaomiKey) {
                        providers.xiaomi = __assign(__assign({}, buildXiaomiProvider()), { apiKey: xiaomiKey });
                    }
                    ollamaKey = (_k = resolveEnvApiKeyVarName("ollama")) !== null && _k !== void 0 ? _k : resolveApiKeyFromProfiles({ provider: "ollama", store: authStore });
                    if (!ollamaKey) return [3 /*break*/, 4];
                    _c = providers;
                    _d = [{}];
                    return [4 /*yield*/, buildOllamaProvider()];
                case 3:
                    _c.ollama = __assign.apply(void 0, [__assign.apply(void 0, _d.concat([(_l.sent())])), { apiKey: ollamaKey }]);
                    _l.label = 4;
