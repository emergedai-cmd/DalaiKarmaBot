...
(0, vitest_1.describe)("openclaw-tools: subagents", function () {
    ...
    (0, vitest_1.it)("sessions_spawn deletes session when cleanup=delete via agent.wait", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, tool.execute("call1b", {
                            task: "do thing",
                            runTimeoutSeconds: 1,
                            cleanup: "delete",
                        })];
