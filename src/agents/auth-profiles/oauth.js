...
var OAUTH_PROVIDER_IDS = new Set((0, pi_ai_1.getOAuthProviders)().map(function (provider) { return provider.id; }));
var isOAuthProvider = function (provider) {
    return OAUTH_PROVIDER_IDS.has(provider);
};
var resolveOAuthProvider = function (provider) {
...
function refreshOAuthTokenWithLock(params) {
    return __awaiter(this, void 0, void 0, function () {
        var authPath, release, store, cred_1, oauthCreds_1, result, _a, _b, _c;
        var _d;
        var _this = this;
            ...
            switch (_e.label) {
                ...
                case 6: return [4 /*yield*/, (function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    oauthProvider = resolveOAuthProvider(cred_1.provider);
                                    if (!oauthProvider) {
                                        return [2 /*return*/, null];
                                    }
                                    return [4 /*yield*/, (0, pi_ai_1.getOAuthApiKey)(oauthProvider, oauthCreds_1)];
