...
(0, vitest_1.describe)("createSystemPromptOverride", function () {
    (0, vitest_1.it)("returns the override prompt trimmed", function () {
        var override = (0, pi_embedded_runner_js_1.createSystemPromptOverride)("OVERRIDE");
        (0, vitest_1.expect)(override()).toBe("OVERRIDE");
    });
    (0, vitest_1.it)("returns an empty string for blank overrides", function () {
        var override = (0, pi_embedded_runner_js_1.createSystemPromptOverride)("  \n  ");
        (0, vitest_1.expect)(override()).toBe("");
    });
});
