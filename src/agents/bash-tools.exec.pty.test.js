...
(0, vitest_1.test)("exec supports pty output", function () { return __awaiter(void 0, void 0, void 0, function () {
    var tool, result, text;
    var _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                tool = (0, bash_tools_exec_1.createExecTool)({ allowBackground: false });
