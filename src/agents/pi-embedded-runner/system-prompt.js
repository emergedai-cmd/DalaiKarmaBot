...
exports.applySystemPromptOverrideToSession = applySystemPromptOverrideToSession;
...
function createSystemPromptOverride(systemPrompt) {
    var override = systemPrompt.trim();
    return function (_defaultPrompt) { return override; };
}
function applySystemPromptOverrideToSession(session, override) {
    var prompt = typeof override === "function" ? override() : override.trim();
    session.agent.setSystemPrompt(prompt);
    var mutableSession = session;
    mutableSession._baseSystemPrompt = prompt;
    mutableSession._rebuildSystemPrompt = function () { return prompt; };
}
