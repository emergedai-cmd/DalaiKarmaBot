    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    authStorage = (0, pi_model_discovery_js_1.discoverAuthStorage)(params.agentDir);
                    modelRegistry = (0, pi_model_discovery_js_1.discoverModels)(authStorage, params.agentDir);
