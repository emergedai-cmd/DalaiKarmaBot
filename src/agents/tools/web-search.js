            ...
            switch (_h.label) {
                ...
                case 1:
                    ...
                    payload_1 = {
                        ...
                        content: (0, external_content_js_1.wrapWebContent)(content),
                        citations: citations,
                    };
                ...
                case 6:
                    ...
                    mapped = results.map(function (entry) {
                        var _a, _b, _c;
                        var description = (_a = entry.description) !== null && _a !== void 0 ? _a : "";
                        var title = (_b = entry.title) !== null && _b !== void 0 ? _b : "";
                        var url = (_c = entry.url) !== null && _c !== void 0 ? _c : "";
                        var rawSiteName = resolveSiteName(url);
                        return {
                            title: title ? (0, external_content_js_1.wrapWebContent)(title, "web_search") : "",
                            url: url, // Keep raw for tool chaining
                            description: description ? (0, external_content_js_1.wrapWebContent)(description, "web_search") : "",
