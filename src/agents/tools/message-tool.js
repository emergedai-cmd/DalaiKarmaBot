...
function createMessageTool(options) {
    ...
    return {
        ...
        execute: function (_toolCallId, args, signal) { return __awaiter(_this, void 0, void 0, function () {
            var err, params, cfg, action, sandboxRoot, _i, _a, key, raw, accountId, gateway, toolContext, result, toolResult;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        params = args;
                        cfg = (_b = options === null || options === void 0 ? void 0 : options.config) !== null && _b !== void 0 ? _b : (0, config_js_1.loadConfig)();
                        action = (0, common_js_1.readStringParam)(params, "action", {
                            required: true,
                        });
                        sandboxRoot = options === null || options === void 0 ? void 0 : options.sandboxRoot;
                        if (!sandboxRoot) return [3 /*break*/, 4];
                        _i = 0, _a = ["filePath", "path"];
                        _d.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 4];
                        key = _a[_i];
                        raw = (0, common_js_1.readStringParam)(params, key, { trim: false });
                        if (!raw) return [3 /*break*/, 3];
                        return [4 /*yield*/, (0, sandbox_paths_js_1.assertSandboxPath)({ filePath: raw, cwd: sandboxRoot, root: sandboxRoot })];
                    case 2:
                        _d.sent();
                        _d.label = 3;
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        accountId = (_c = (0, common_js_1.readStringParam)(params, "accountId")) !== null && _c !== void 0 ? _c : agentAccountId;
                        if (accountId) {
