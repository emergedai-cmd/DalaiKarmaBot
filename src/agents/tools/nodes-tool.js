...
var NodesToolSchema = typebox_1.Type.Object({
    ...
    // invoke
    invokeCommand: typebox_1.Type.Optional(typebox_1.Type.String()),
    invokeParamsJson: typebox_1.Type.Optional(typebox_1.Type.String()),
});
        ...
        execute: function (_toolCallId, args) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 42:
                        nodeId = _l.sent();
                        invokeCommand = (0, common_js_1.readStringParam)(params, "invokeCommand", { required: true });
                        invokeParamsJson = typeof params.invokeParamsJson === "string" ? params.invokeParamsJson.trim() : "";
                        invokeParams = {};
                        if (invokeParamsJson) {
                            try {
                                ...
                                throw new Error("invokeParamsJson must be valid JSON: ".concat(message), {
                                    cause: err,
                                });
                            }
                        }
                    ...
                    case 43:
                        raw = _l.sent();
                        return [2 /*return*/, (0, common_js_1.jsonResult)(raw !== null && raw !== void 0 ? raw : {})];
                    case 44: throw new Error("Unknown action: ".concat(action));
                    ...
                    case 46:
                        ...
                        throw new Error("agent=".concat(agentLabel, " node=").concat(nodeLabel, " gateway=").concat(gatewayLabel, " action=").concat(action, ": ").concat(message), { cause: err_1 });
