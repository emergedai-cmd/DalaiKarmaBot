...
var DEFAULT_UPDATE_TIMEOUT_MS = 20 * 60000;
                ...
                switch (_k.label) {
                    ...
                    case 17:
                        ...
                        restartDelayMs = typeof params.restartDelayMs === "number" && Number.isFinite(params.restartDelayMs)
                            ? Math.floor(params.restartDelayMs)
                            : undefined;
                        updateGatewayOpts = __assign(__assign({}, gatewayOpts), { timeoutMs: timeoutMs !== null && timeoutMs !== void 0 ? timeoutMs : DEFAULT_UPDATE_TIMEOUT_MS });
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("update.run", updateGatewayOpts, {
                                sessionKey: sessionKey,
                                note: note,
                                restartDelayMs: restartDelayMs,
                                timeoutMs: timeoutMs !== null && timeoutMs !== void 0 ? timeoutMs : DEFAULT_UPDATE_TIMEOUT_MS,
                            })];
                    case 18:
                        result = _k.sent();
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ ok: true, result: result })];
