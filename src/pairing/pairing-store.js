...
function pruneExcessRequests(reqs, maxPending) {
    ...
    var sorted = reqs.slice().toSorted(function (a, b) { return resolveLastSeenAt(a) - resolveLastSeenAt(b); });
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 3: return [2 /*return*/, pruned
                                            ...
                                            .slice()
                                            .toSorted(function (a, b) { return a.createdAt.localeCompare(b.createdAt); })];
                                }
                            });
                        }); })];
