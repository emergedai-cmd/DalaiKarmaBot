...
(0, vitest_1.describe)("config strict validation", function () {
    (0, vitest_1.it)("rejects unknown fields", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)("flags legacy config entries without auto-migrating", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, test_helpers_js_1.withTempHome)(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var configDir, readConfigFileSnapshot, snap;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                ...
                                case 4:
                                    ...
                                    (0, vitest_1.expect)(snap.legacyIssues).not.toHaveLength(0);
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
