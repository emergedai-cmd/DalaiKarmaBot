...
exports.TelegramConfigSchema = exports.TelegramAccountSchemaBase.extend({
    ...
    validateTelegramCustomCommands(value, ctx);
    var baseWebhookUrl = typeof value.webhookUrl === "string" ? value.webhookUrl.trim() : "";
    var baseWebhookSecret = typeof value.webhookSecret === "string" ? value.webhookSecret.trim() : "";
    ...
    for (var _i = 0, _a = Object.entries(value.accounts); _i < _a.length; _i++) {
        var _b = _a[_i], accountId = _b[0], account = _b[1];
        if (!account) {
            continue;
        }
        ...
        var accountWebhookUrl = typeof account.webhookUrl === "string" ? account.webhookUrl.trim() : "";
        if (!accountWebhookUrl) {
            continue;
        }
        var accountSecret = typeof account.webhookSecret === "string" ? account.webhookSecret.trim() : "";
...
exports.MSTeamsConfigSchema = zod_1.z
    ...
    mediaAuthAllowHosts: zod_1.z.array(zod_1.z.string()).optional(),
    requireMention: zod_1.z.boolean().optional(),
    historyLimit: zod_1.z.number().int().min(0).optional(),
    dmHistoryLimit: zod_1.z.number().int().min(0).optional(),
    dms: zod_1.z.record(zod_1.z.string(), zod_schema_core_js_1.DmConfigSchema.optional()).optional(),
