...
function searchStickers(query, limit) {
    ...
    return results
        .toSorted(function (a, b) { return b.score - a.score; })
        .slice(0, limit)
...
function getCacheStats() {
    ...
    var sorted = __spreadArray([], stickers, true).toSorted(function (a, b) { return new Date(a.cachedAt).getTime() - new Date(b.cachedAt).getTime(); });
    return {
