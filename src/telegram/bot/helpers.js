...
exports.resolveTelegramThreadSpec = resolveTelegramThreadSpec;
...
function resolveTelegramThreadSpec(params) {
    if (params.isGroup) {
        var id = resolveTelegramForumThreadId({
...
function buildTelegramThreadParams(thread) {
    ...
    var normalized = Math.trunc(thread.id);
...
function expandTextLinks(text, entities) {
    ...
    var textLinks = entities
        ...
        .toSorted(function (a, b) { return b.offset - a.offset; });
...
function describeReplyTarget(msg) {
    ...
    var senderLabel = sender !== null && sender !== void 0 ? sender : "unknown sender";
    return {
