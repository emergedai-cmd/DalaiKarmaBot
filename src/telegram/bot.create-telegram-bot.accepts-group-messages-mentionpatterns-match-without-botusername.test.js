...
(0, vitest_1.describe)("createTelegramBot", function () {
    ...
    (0, vitest_1.it)("accepts group messages when mentionPatterns match even if another user is mentioned", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    (0, vitest_1.expect)(replySpy).toHaveBeenCalledTimes(1);
                    (0, vitest_1.expect)(replySpy.mock.calls[0][0].WasMentioned).toBe(true);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("keeps group envelope headers stable (sender identity is separate)", function () { return __awaiter(void 0, void 0, void 0, function () {
        var replySpy, handler, payload, expectedTimestamp, timestampPattern;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
