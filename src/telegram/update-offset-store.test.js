        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, promises_1.default.mkdtemp(node_path_1.default.join(node_os_1.default.tmpdir(), "openclaw-telegram-"))];
                case 1:
                    dir = _a.sent();
...
(0, vitest_1.describe)("telegram update offset store", function () {
    (0, vitest_1.it)("persists and reloads the last update id", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempStateDir(function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _a = vitest_1.expect;
                                    return [4 /*yield*/, (0, update_offset_store_js_1.readTelegramUpdateOffset)({ accountId: "primary" })];
                                case 1:
                                ...
                                case 2:
                                    ...
                                    return [4 /*yield*/, (0, update_offset_store_js_1.readTelegramUpdateOffset)({ accountId: "primary" })];
                                case 3:
                                    _b.apply(void 0, [_c.sent()]).toBe(421);
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
