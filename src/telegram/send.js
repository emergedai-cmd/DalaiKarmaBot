...
function sendMessageTelegram(to_1, text_1) {
    return __awaiter(this, arguments, void 0, function (to, text, opts) {
        var cfg, account, token, target, chatId, client, api, mediaUrl, replyMarkup, messageThreadId, threadSpec, threadIdParams, threadParams, quoteText, hasThreadParams, request, logHttpError, requestWithDiag, wrapChatNotFound, textMode, tableMode, renderHtmlText, linkPreviewEnabled, linkPreviewOptions, sendTelegramText, media, kind, isGif, fileName, file_1, _a, caption, followUpText, htmlCaption, needsSeparateText, baseMediaParams, mediaParams_1, result, useVoice, mediaMessageId, resolvedChatId, textParams_1, textRes, textParams, res, messageId;
        var _this = this;
        ...
        return __generator(this, function (_s) {
            switch (_s.label) {
                case 0:
                    ...
                    threadSpec = messageThreadId != null ? { id: messageThreadId, scope: "forum" } : undefined;
                    threadIdParams = (0, helpers_js_1.buildTelegramThreadParams)(threadSpec);
...
function sendStickerTelegram(to_1, fileId_1) {
    return __awaiter(this, arguments, void 0, function (to, fileId, opts) {
        var cfg, account, token, target, chatId, client, api, messageThreadId, threadSpec, threadIdParams, threadParams, hasThreadParams, request, logHttpError, requestWithDiag, wrapChatNotFound, stickerParams, result, messageId, resolvedChatId;
        var _a, _b, _c, _d;
        if (opts === void 0) { opts = {}; }
