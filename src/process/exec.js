...
function resolveCommand(command) {
    ...
    var basename = node_path_1.default.basename(command).toLowerCase();
    ...
    var cmdCommands = ["npm", "pnpm", "yarn", "npx"];
    if (cmdCommands.includes(basename)) {
        return "".concat(command, ".cmd");
    }
    return command;
}
    ...
    return __awaiter(this, arguments, void 0, function (command, args, opts) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, execFileAsync(resolveCommand(command), args, options)];
                case 2:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    child = (0, node_child_process_1.spawn)(resolveCommand(argv[0]), argv.slice(1), {
                        stdio: stdio,
                        cwd: cwd,
                        env: resolvedEnv,
