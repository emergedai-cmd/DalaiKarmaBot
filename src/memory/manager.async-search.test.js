...
(0, vitest_1.describe)("memory search async sync", function () {
    var workspaceDir;
    var indexPath;
    var manager = null;
    (0, vitest_1.beforeEach)(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, promises_1.default.mkdtemp(node_path_1.default.join(node_os_1.default.tmpdir(), "openclaw-mem-async-"))];
                case 1:
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, promises_1.default.writeFile(node_path_1.default.join(workspaceDir, "memory", "2026-01-07.md"), "hello\n")];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    (0, vitest_1.it)("does not await sync when searching", function () { return __awaiter(void 0, void 0, void 0, function () {
        var cfg, result, pending, resolved;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cfg = {
                ...
                case 1:
                    ...
                    manager.sync = vitest_1.vi.fn(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, pending];
                    }); }); });
                    return [4 /*yield*/, Promise.race([
                            manager.search("hello").then(function () { return true; }),
                            new Promise(function (resolve) { return setTimeout(function () { return resolve(false); }, 1000); }),
                        ])];
                case 2:
                    resolved = _a.sent();
