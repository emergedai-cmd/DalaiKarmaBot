...
exports.syncMemoryFiles = syncMemoryFiles;
...
function syncMemoryFiles(params) {
    return __awaiter(this, void 0, void 0, function () {
        var files, fileEntries, activePaths, tasks, staleRows, _i, staleRows_1, stale;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, internal_js_1.listMemoryFiles)(params.workspaceDir, params.extraPaths)];
                case 1:
                    files = _a.sent();
                    return [4 /*yield*/, Promise.all(files.map(function (file) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, (0, internal_js_1.buildFileEntry)(file, params.workspaceDir)];
                        }); }); }))];
                case 2:
                    fileEntries = _a.sent();
