            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, ({
                        ...
                        provider: {
                            ...
                            embedBatch: function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
...
(0, vitest_1.describe)("memory manager sync failures", function () {
    var workspaceDir;
    var indexPath;
    var manager = null;
    (0, vitest_1.beforeEach)(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, promises_1.default.writeFile(node_path_1.default.join(workspaceDir, "MEMORY.md"), "Hello")];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    (0, vitest_1.it)("does not raise unhandledRejection when watch-triggered sync fails", function () { return __awaiter(void 0, void 0, void 0, function () {
        var unhandled, handler, cfg, result, syncSpy, syncPromise;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    syncSpy = vitest_1.vi.spyOn(manager, "sync");
                    // Call the internal scheduler directly; it uses fire-and-forget sync.
                    manager.scheduleWatchSync();
                    return [4 /*yield*/, vitest_1.vi.runOnlyPendingTimersAsync()];
                case 2:
                    _b.sent();
                    syncPromise = (_a = syncSpy.mock.results[0]) === null || _a === void 0 ? void 0 : _a.value;
                    vitest_1.vi.useRealTimers();
                    if (!syncPromise) return [3 /*break*/, 4];
                    return [4 /*yield*/, syncPromise.catch(function () { return undefined; })];
                case 3:
                    _b.sent();
                    _b.label = 4;
                case 4:
