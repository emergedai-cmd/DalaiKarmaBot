...
var setup_js_1 = require("../../commands/setup.js");
...
function registerSetupCommand(program) {
    ...
    program
        ...
        return "\n".concat(theme_js_1.theme.muted("Docs:"), " ").concat((0, links_js_1.formatDocsLink)("/cli/setup", "docs.openclaw.ai/cli/setup"), "\n");
    })
        .option("--workspace <dir>", "Agent workspace directory (default: ~/.openclaw/workspace; stored as agents.defaults.workspace)")
            ...
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, cli_utils_js_1.runCommandWithRuntime)(runtime_js_1.defaultRuntime, function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    hasWizardFlags = (0, command_options_js_1.hasExplicitOptions)(command, [
                                        "wizard",
                                        "nonInteractive",
                                        "mode",
                                        "remoteUrl",
                                    ...
                                    if (!(opts.wizard || hasWizardFlags)) return [3 /*break*/, 2];
                                ...
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                                case 2: return [4 /*yield*/, (0, setup_js_1.setupCommand)({ workspace: opts.workspace }, runtime_js_1.defaultRuntime)];
                                case 3:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
