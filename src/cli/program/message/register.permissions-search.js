...
exports.registerMessagePermissionsCommand = registerMessagePermissionsCommand;
exports.registerMessageSearchCommand = registerMessageSearchCommand;
...
function registerMessagePermissionsCommand(message, helpers) {
    ...
    helpers
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("permissions", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function registerMessageSearchCommand(message, helpers) {
    ...
    helpers
        ...
        .option("--channel-ids <id>", "Channel id (repeat)", helpers_js_1.collectOption, [])
        .option("--author-id <id>", "Author id")
        .option("--author-ids <id>", "Author id (repeat)", helpers_js_1.collectOption, [])
        .option("--limit <n>", "Result limit")
        .action(function (opts) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("search", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
