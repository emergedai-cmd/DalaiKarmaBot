...
exports.registerMessageEmojiCommands = registerMessageEmojiCommands;
exports.registerMessageStickerCommands = registerMessageStickerCommands;
var helpers_js_1 = require("../helpers.js");
function registerMessageEmojiCommands(message, helpers) {
    var _this = this;
    var emoji = message.command("emoji").description("Emoji actions");
    helpers
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("emoji-list", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    helpers
        ...
        .option("--role-ids <id>", "Role id (repeat)", helpers_js_1.collectOption, [])
        .action(function (opts) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("emoji-upload", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function registerMessageStickerCommands(message, helpers) {
    var _this = this;
    var sticker = message.command("sticker").description("Sticker actions");
    helpers
        .withMessageBase(helpers.withRequiredMessageTarget(sticker.command("send").description("Send stickers")))
        .requiredOption("--sticker-id <id>", "Sticker id (repeat)", helpers_js_1.collectOption)
        .option("-m, --message <text>", "Optional message body")
        .action(function (opts) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("sticker", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    helpers
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("sticker-upload", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
