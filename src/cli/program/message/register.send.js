...
exports.registerMessageSendCommand = registerMessageSendCommand;
function registerMessageSendCommand(message, helpers) {
    var _this = this;
    helpers
        .withMessageBase(helpers
        .withRequiredMessageTarget(message
        .command("send")
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("send", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
