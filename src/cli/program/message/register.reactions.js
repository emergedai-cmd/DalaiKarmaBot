...
exports.registerMessageReactionsCommands = registerMessageReactionsCommands;
function registerMessageReactionsCommands(message, helpers) {
    var _this = this;
    helpers
        .withMessageBase(helpers.withRequiredMessageTarget(message.command("react").description("Add or remove a reaction")))
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("react", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    helpers
        .withMessageBase(helpers.withRequiredMessageTarget(message.command("reactions").description("List reactions on a message")))
        .requiredOption("--message-id <id>", "Message id")
        .option("--limit <n>", "Result limit")
        .action(function (opts) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("reactions", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
