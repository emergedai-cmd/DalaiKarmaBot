...
exports.registerMessagePinCommands = registerMessagePinCommands;
    ...
    var pins = [
        helpers
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, helpers.runMessageAction("pin", opts)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        helpers
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, helpers.runMessageAction("unpin", opts)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        helpers
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, helpers.runMessageAction("list-pins", opts)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
