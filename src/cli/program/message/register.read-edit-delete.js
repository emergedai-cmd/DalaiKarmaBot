...
exports.registerMessageReadEditDeleteCommands = registerMessageReadEditDeleteCommands;
function registerMessageReadEditDeleteCommands(message, helpers) {
    ...
    helpers
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("read", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    helpers
        .withMessageBase(helpers.withRequiredMessageTarget(message
        .command("edit")
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("edit", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    helpers
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("delete", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
