...
exports.registerMessageBroadcastCommand = registerMessageBroadcastCommand;
...
function registerMessageBroadcastCommand(message, helpers) {
    ...
    helpers
        ...
        .requiredOption("--targets <target...>", channel_target_js_1.CHANNEL_TARGETS_DESCRIPTION)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("broadcast", options)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
