...
exports.registerMessagePollCommand = registerMessagePollCommand;
var helpers_js_1 = require("../helpers.js");
function registerMessagePollCommand(message, helpers) {
    var _this = this;
    helpers
        .withMessageBase(helpers.withRequiredMessageTarget(message.command("poll").description("Send a poll")))
        .requiredOption("--poll-question <text>", "Poll question")
        .option("--poll-option <choice>", "Poll option (repeat 2-12 times)", helpers_js_1.collectOption, [])
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers.runMessageAction("poll", opts)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
