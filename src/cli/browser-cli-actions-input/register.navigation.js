...
exports.registerBrowserNavigationCommands = registerBrowserNavigationCommands;
...
function registerBrowserNavigationCommands(browser, parentOpts) {
    ...
    browser
        ...
        var _a, parent, profile, result, err_1;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    runtime_js_1.defaultRuntime.log("navigated to ".concat((_c = result.url) !== null && _c !== void 0 ? _c : url));
                    return [3 /*break*/, 4];
                case 3:
                    err_1 = _d.sent();
    ...
    browser
        ...
        var _a, parent, profile, result, err_2;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    runtime_js_1.defaultRuntime.log("resized to ".concat(width, "x").concat(height));
                    return [3 /*break*/, 4];
                case 3:
                    err_2 = _c.sent();
