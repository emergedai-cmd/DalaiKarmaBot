...
function promptYesNo(question_1) {
    return __awaiter(this, arguments, void 0, function (question, defaultYes) {
        var rl, suffix, answer;
        if (defaultYes === void 0) { defaultYes = false; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    // Simple Y/N prompt honoring global --yes and verbosity flags.
                    if ((0, globals_js_1.isVerbose)() && (0, globals_js_1.isYes)()) {
                        return [2 /*return*/, true];
                    } // redundant guard when both flags set
                    if ((0, globals_js_1.isYes)()) {
                        return [2 /*return*/, true];
                    }
                ...
                case 1:
                    ...
                    return [2 /*return*/, answer.startsWith("y")];
            }
        });
    });
}
