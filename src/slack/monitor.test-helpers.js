...
exports.defaultSlackTestConfig = exports.flush = exports.getSlackClient = exports.getSlackHandlers = exports.getSlackTestState = void 0;
exports.waitForSlackEvent = waitForSlackEvent;
exports.resetSlackTestState = resetSlackTestState;
var vitest_1 = require("vitest");
var slackTestState = vitest_1.vi.hoisted(function () { return ({
    config: {},
    sendMock: vitest_1.vi.fn(),
    replyMock: vitest_1.vi.fn(),
    updateLastRouteMock: vitest_1.vi.fn(),
    reactMock: vitest_1.vi.fn(),
    readAllowFromStoreMock: vitest_1.vi.fn(),
    upsertPairingRequestMock: vitest_1.vi.fn(),
}); });
var getSlackTestState = function () { return slackTestState; };
exports.getSlackTestState = getSlackTestState;
var getSlackHandlers = function () {
    return globalThis.__slackHandlers;
};
exports.getSlackHandlers = getSlackHandlers;
...
exports.flush = flush;
function waitForSlackEvent(name) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if ((_a = (0, exports.getSlackHandlers)()) === null || _a === void 0 ? void 0 : _a.has(name)) {
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, (0, exports.flush)()];
                case 2:
                    _b.sent();
                    _b.label = 3;
                case 3:
...
var defaultSlackTestConfig = function () { return ({
    messages: {
        responsePrefix: "PFX",
        ackReaction: "👀",
...
exports.defaultSlackTestConfig = defaultSlackTestConfig;
function resetSlackTestState(config) {
    var _a;
    if (config === void 0) { config = (0, exports.defaultSlackTestConfig)(); }
    ...
    (_a = (0, exports.getSlackHandlers)()) === null || _a === void 0 ? void 0 : _a.clear();
}
vitest_1.vi.mock("../config/config.js", function (importOriginal) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                actual = _a.sent();
                return [2 /*return*/, __assign(__assign({}, actual), { loadConfig: function () { return slackTestState.config; } })];
        }
    });
}); });
vitest_1.vi.mock("../auto-reply/reply.js", function () { return ({
    getReplyFromConfig: function () {
        ...
        return slackTestState.replyMock.apply(slackTestState, args);
    },
}); });
...
vitest_1.vi.mock("./send.js", function () { return ({
    sendMessageSlack: function () {
        ...
        return slackTestState.sendMock.apply(slackTestState, args);
    },
}); });
vitest_1.vi.mock("../pairing/pairing-store.js", function () { return ({
    readChannelAllowFromStore: function () {
        ...
        return slackTestState.readAllowFromStoreMock.apply(slackTestState, args);
    },
    upsertChannelPairingRequest: function () {
        ...
        return slackTestState.upsertPairingRequestMock.apply(slackTestState, args);
    },
}); });
vitest_1.vi.mock("../config/sessions.js", function () { return ({
    ...
    updateLastRoute: function () {
        ...
        return slackTestState.updateLastRouteMock.apply(slackTestState, args);
    },
    ...
    var client = {
        ...
        reactions: {
            add: function () {
                ...
                return slackTestState.reactMock.apply(slackTestState, args);
            },
        },
    };
