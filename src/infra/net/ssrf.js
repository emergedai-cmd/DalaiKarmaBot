...
function normalizeHostnameSet(values) {
    ...
    return new Set(values.map(function (value) { return normalizeHostname(value); }).filter(Boolean));
}
...
function resolvePinnedHostnameWithPolicy(hostname_1) {
    return __awaiter(this, arguments, void 0, function (hostname, params) {
        var normalized, allowPrivateNetwork, allowedHostnames, isExplicitAllowed, lookupFn, results, _i, results_1, entry, addresses;
        var _a, _b, _c;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    allowPrivateNetwork = Boolean((_a = params.policy) === null || _a === void 0 ? void 0 : _a.allowPrivateNetwork);
                    allowedHostnames = normalizeHostnameSet((_b = params.policy) === null || _b === void 0 ? void 0 : _b.allowedHostnames);
                    isExplicitAllowed = allowedHostnames.has(normalized);
                    ...
                    lookupFn = (_c = params.lookupFn) !== null && _c !== void 0 ? _c : promises_1.lookup;
...
function resolvePinnedHostname(hostname_1) {
    return __awaiter(this, arguments, void 0, function (hostname, lookupFn) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, resolvePinnedHostnameWithPolicy(hostname, { lookupFn: lookupFn })];
