...
function ensureBinary(name_1) {
    return __awaiter(this, arguments, void 0, function (name, exec, runtime) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, exec("which", [name]).catch(function () {
                        runtime.error("Missing required binary: ".concat(name, ". Please install it."));
                        runtime.exit(1);
                    })];
                case 1:
                    // Abort early if a required CLI tool is missing.
