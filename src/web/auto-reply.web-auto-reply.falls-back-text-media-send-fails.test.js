...
(0, vitest_1.describe)("web auto-reply", function () {
    ...
    (0, vitest_1.it)("falls back to text when media send fails", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMedia, reply, sendComposing, resolver, capturedOnMessage, listenerFactory, smallPng, fetchMock, fallback;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    sendMedia = vitest_1.vi.fn().mockRejectedValue(new Error("boom"));
                ...
                case 1:
                    ...
                    fetchMock = vitest_1.vi.spyOn(globalThis, "fetch").mockResolvedValue({
                        ...
                        arrayBuffer: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, smallPng.buffer.slice(smallPng.byteOffset, smallPng.byteOffset + smallPng.byteLength)];
                        }); }); },
                ...
                case 3:
                    ...
                    fallback = (_a = reply.mock.calls[0]) === null || _a === void 0 ? void 0 : _a[0];
                    (0, vitest_1.expect)(fallback).toContain("hi");
                    (0, vitest_1.expect)(fallback).toContain("Media failed");
                    fetchMock.mockRestore();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("returns a warning when remote media fetch 404s", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMedia, reply, sendComposing, resolver, capturedOnMessage, listenerFactory, fetchMock, fallback;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 2:
                    _b.sent();
                    (0, vitest_1.expect)(sendMedia).not.toHaveBeenCalled();
                    fallback = (_a = reply.mock.calls[0]) === null || _a === void 0 ? void 0 : _a[0];
                    (0, vitest_1.expect)(fallback).toContain("caption");
                    (0, vitest_1.expect)(fallback).toContain("Media failed");
                    (0, vitest_1.expect)(fallback).toContain("404");
                    fetchMock.mockRestore();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("compresses media over 5MB and still sends it", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    bigPng = _a.sent();
                    (0, vitest_1.expect)(bigPng.length).toBeGreaterThan(5 * 1024 * 1024);
                    fetchMock = vitest_1.vi.spyOn(globalThis, "fetch").mockResolvedValue({
                        ok: true,
                        body: true,
                        arrayBuffer: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                case 3:
                    ...
                    (0, vitest_1.expect)(payload.image.length).toBeLessThanOrEqual(5 * 1024 * 1024);
