...
(0, vitest_1.describe)("broadcast groups", function () {
    (0, vitest_1.it)("broadcasts sequentially in configured order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMedia, reply, sendComposing, seen, resolver, capturedOnMessage, listenerFactory;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    (0, test_helpers_js_1.setLoadConfigMock)({
                    ...
                    seen = [];
                    resolver = vitest_1.vi.fn(function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                ...
                case 2:
                    ...
                    (0, vitest_1.expect)(seen[0]).toContain("agent:alfred:");
                    (0, vitest_1.expect)(seen[1]).toContain("agent:baerbel:");
                    (0, test_helpers_js_1.resetLoadConfigMock)();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("shares group history across broadcast agents and clears after replying", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMedia, reply, sendComposing, resolver, capturedOnMessage, listenerFactory, _i, _a, call, payload, _b, _c, call, payload;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    _d.sent();
                    (0, vitest_1.expect)(resolver).toHaveBeenCalledTimes(2);
                    for (_i = 0, _a = resolver.mock.calls.slice(0, 2); _i < _a.length; _i++) {
                        call = _a[_i];
                        payload = call[0];
                ...
                case 4:
                    _d.sent();
                    (0, vitest_1.expect)(resolver).toHaveBeenCalledTimes(4);
                    for (_b = 0, _c = resolver.mock.calls.slice(2, 4); _b < _c.length; _b++) {
                        call = _c[_b];
                        payload = call[0];
                        (0, vitest_1.expect)(payload.Body).not.toContain("Alice (+111): hello group");
    ...
    (0, vitest_1.it)("broadcasts in parallel by default", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMedia, reply, sendComposing, started, release, gate, resolver, capturedOnMessage, listenerFactory;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    (0, test_helpers_js_1.setLoadConfigMock)({
                    ...
                    resolver = vitest_1.vi.fn(function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    started += 1;
                                    if (!(started < 2)) return [3 /*break*/, 2];
                                    return [4 /*yield*/, gate];
                                case 1:
                                    _a.sent();
                                    return [3 /*break*/, 3];
                                case 2:
                                    ...
                                    _a.label = 3;
                                case 3: return [2 /*return*/, { text: "ok" }];
                            }
                        });
                    }); });
                    listenerFactory = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
