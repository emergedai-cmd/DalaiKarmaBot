...
(0, vitest_1.describe)("applyGroupGating", function () {
    (0, vitest_1.it)("treats reply-to-bot as implicit mention", function () {
        var groupHistories = new Map();
        var result = (0, group_gating_js_1.applyGroupGating)({
            cfg: baseConfig,
            msg: {
                id: "m1",
                from: "123@g.us",
            ...
            logVerbose: function () { },
            replyLogger: { debug: function () { } },
        });
        (0, vitest_1.expect)(result.shouldProcess).toBe(true);
    });
});
