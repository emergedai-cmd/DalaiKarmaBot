...
var sendMessageMock = vitest_1.vi.fn();
...
(0, vitest_1.describe)("checkInboundAccessControl", function () {
    (0, vitest_1.it)("suppresses pairing replies for historical DMs on connect", function () { return __awaiter(void 0, void 0, void 0, function () {
        var connectedAtMs, messageTimestampMs, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    connectedAtMs = 1000000;
                    messageTimestampMs = connectedAtMs - 31000;
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(upsertPairingRequestMock).not.toHaveBeenCalled();
                    (0, vitest_1.expect)(sendMessageMock).not.toHaveBeenCalled();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("sends pairing replies for live DMs", function () { return __awaiter(void 0, void 0, void 0, function () {
        var connectedAtMs, messageTimestampMs, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    connectedAtMs = 1000000;
                    messageTimestampMs = connectedAtMs - 10000;
                    return [4 /*yield*/, (0, access_control_js_1.checkInboundAccessControl)({
                            accountId: "default",
                            from: "+15550001111",
                            selfE164: "+15550009999",
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(sendMessageMock).toHaveBeenCalled();
                    return [2 /*return*/];
            }
        });
    }); });
