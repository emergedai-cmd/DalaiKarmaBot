...
(0, vitest_1.describe)("web auto-reply", function () {
    ...
    (0, vitest_1.it)("uses per-agent mention patterns for group gating", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)("allows group messages when whatsapp groups default disables mention gating", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMedia, reply, sendComposing, resolver, capturedOnMessage, listenerFactory;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)("blocks group messages when whatsapp groups is set without a wildcard", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMedia, reply, sendComposing, resolver, capturedOnMessage, listenerFactory;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)("honors per-group mention overrides when conversationId uses session key", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMedia, reply, sendComposing, resolver, capturedOnMessage, listenerFactory;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
