...
vitest_1.vi.mock("./session.js", function () {
    var ev = new node_events_1.EventEmitter();
    var sock = {
        ev: ev,
        ws: { close: vitest_1.vi.fn() },
        sendPresenceUpdate: vitest_1.vi.fn(),
...
(0, vitest_1.describe)("web login", function () {
    ...
    (0, vitest_1.it)("loginWeb waits for connection and closes", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sock, close, waiter;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createWaSocket()];
                case 1:
                    sock = _a.sent();
                    close = vitest_1.vi.spyOn(sock.ws, "close");
                    waiter = vitest_1.vi.fn().mockResolvedValue(undefined);
                    return [4 /*yield*/, (0, login_js_1.loginWeb)(false, waiter)];
                case 2:
                    _a.sent();
