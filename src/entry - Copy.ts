...
process.title = (process.env.DALAIKARMABOT_LOG_PREFIX ?? process.env.OPENCLAW_LOG_PREFIX ?? "openclaw");
...
function ensureExperimentalWarningSuppressed(): boolean {
  ...
  child.once("error", (error) => {
    console.error(
      "[" + (process.env.DALAIKARMABOT_LOG_PREFIX ?? "openclaw") + "] Failed to respawn CLI:",
