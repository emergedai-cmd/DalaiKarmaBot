...
(0, vitest_1.describe)("doctor command", function () {
    (0, vitest_1.it)("migrates routing.allowFrom to channels.whatsapp.allowFrom", { timeout: 60000 }, function () { return __awaiter(void 0, void 0, void 0, function () {
        var doctorCommand, runtime, written;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    doctorCommand = (_c.sent()).doctorCommand;
                    runtime = {
                        log: vitest_1.vi.fn(),
                    ...
                    return [4 /*yield*/, doctorCommand(runtime, { nonInteractive: true, repair: true })];
                case 2:
                    _c.sent();
                    (0, vitest_1.expect)(writeConfigFile).toHaveBeenCalledTimes(1);
                    written = (_a = writeConfigFile.mock.calls[0]) === null || _a === void 0 ? void 0 : _a[0];
                    (0, vitest_1.expect)((_b = written.channels) === null || _b === void 0 ? void 0 : _b.whatsapp).toEqual({
                        allowFrom: ["+15555550123"],
                    });
                    (0, vitest_1.expect)(written.routing).toBeUndefined();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("skips legacy gateway services migration", { timeout: 60000 }, function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, doctorCommand(runtime)];
                case 2:
                    _a.sent();
                    (0, vitest_1.expect)(uninstallLegacyGatewayServices).not.toHaveBeenCalled();
                    (0, vitest_1.expect)(serviceInstall).not.toHaveBeenCalled();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("offers to update first for git checkouts", function () { return __awaiter(void 0, void 0, void 0, function () {
        var root, doctorCommand, runtime;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    delete process.env.OPENCLAW_UPDATE_IN_PROGRESS;
                ...
                case 2:
                    _a.sent();
                    (0, vitest_1.expect)(runGatewayUpdate).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ cwd: root }));
                    (0, vitest_1.expect)(readConfigFileSnapshot).not.toHaveBeenCalled();
                    (0, vitest_1.expect)(note.mock.calls.some(function (_a) {
                        var title = _a[1];
                        return typeof title === "string" && title === "Update result";
                    })).toBe(true);
                    return [2 /*return*/];
            }
        });
