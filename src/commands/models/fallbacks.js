...
exports.modelsFallbacksListCommand = modelsFallbacksListCommand;
exports.modelsFallbacksAddCommand = modelsFallbacksAddCommand;
exports.modelsFallbacksRemoveCommand = modelsFallbacksRemoveCommand;
exports.modelsFallbacksClearCommand = modelsFallbacksClearCommand;
...
function modelsFallbacksListCommand(opts, runtime) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            ...
            fallbacks = (_e = (_d = (_c = (_b = cfg.agents) === null || _b === void 0 ? void 0 : _b.defaults) === null || _c === void 0 ? void 0 : _c.model) === null || _d === void 0 ? void 0 : _d.fallbacks) !== null && _e !== void 0 ? _e : [];
            if (opts.json) {
            ...
            runtime.log("Fallbacks (".concat(fallbacks.length, "):"));
...
function modelsFallbacksAddCommand(modelRaw, runtime) {
    return __awaiter(this, void 0, void 0, function () {
        var updated;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, (0, shared_js_1.updateConfig)(function (cfg) {
                        ...
                        var existing = (_f = (_e = (_d = (_c = cfg.agents) === null || _c === void 0 ? void 0 : _c.defaults) === null || _d === void 0 ? void 0 : _d.model) === null || _e === void 0 ? void 0 : _e.fallbacks) !== null && _f !== void 0 ? _f : [];
                ...
                case 1:
                    ...
                    runtime.log("Fallbacks: ".concat(((_d = (_c = (_b = (_a = updated.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.model) === null || _c === void 0 ? void 0 : _c.fallbacks) !== null && _d !== void 0 ? _d : []).join(", ")));
                    return [2 /*return*/];
            }
        });
    });
}
function modelsFallbacksRemoveCommand(modelRaw, runtime) {
    return __awaiter(this, void 0, void 0, function () {
        var updated;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, (0, shared_js_1.updateConfig)(function (cfg) {
                        ...
                        var existing = (_d = (_c = (_b = (_a = cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.model) === null || _c === void 0 ? void 0 : _c.fallbacks) !== null && _d !== void 0 ? _d : [];
                        ...
                        if (filtered.length === existing.length) {
                            throw new Error("Fallback not found: ".concat(targetKey));
                        }
                        var existingModel = (_f = (_e = cfg.agents) === null || _e === void 0 ? void 0 : _e.defaults) === null || _f === void 0 ? void 0 : _f.model;
                        return __assign(__assign({}, cfg), { agents: __assign(__assign({}, cfg.agents), { defaults: __assign(__assign({}, (_g = cfg.agents) === null || _g === void 0 ? void 0 : _g.defaults), { model: __assign(__assign({}, ((existingModel === null || existingModel === void 0 ? void 0 : existingModel.primary) ? { primary: existingModel.primary } : undefined)), { fallbacks: filtered }) }) }) });
                    })];
                case 1:
                    updated = _e.sent();
                    (0, logging_js_1.logConfigUpdated)(runtime);
...
function modelsFallbacksClearCommand(runtime) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, shared_js_1.updateConfig)(function (cfg) {
                        var _a, _b, _c;
                        var existingModel = (_b = (_a = cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.model;
                        return __assign(__assign({}, cfg), { agents: __assign(__assign({}, cfg.agents), { defaults: __assign(__assign({}, (_c = cfg.agents) === null || _c === void 0 ? void 0 : _c.defaults), { model: __assign(__assign({}, ((existingModel === null || existingModel === void 0 ? void 0 : existingModel.primary) ? { primary: existingModel.primary } : undefined)), { fallbacks: [] }) }) }) });
                    })];
                case 1:
                    _a.sent();
                    (0, logging_js_1.logConfigUpdated)(runtime);
