...
var loadOpenClawPlugins = vitest_1.vi.fn().mockReturnValue({ plugins: [], diagnostics: [] });
...
(0, vitest_1.describe)("doctor command", function () {
    (0, vitest_1.it)("runs legacy state migrations in non-interactive mode without prompting", function () { return __awaiter(void 0, void 0, void 0, function () {
