...
(0, vitest_1.describe)("doctor command", function () {
    (0, vitest_1.it)("runs legacy state migrations in yes mode without prompting", function () { return __awaiter(void 0, void 0, void 0, function () {
        var doctorCommand, runtime, _a, detectLegacyStateMigrations, runLegacyStateMigrations;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    doctorCommand = (_b.sent()).doctorCommand;
                    runtime = {
                        log: vitest_1.vi.fn(),
                        error: vitest_1.vi.fn(),
                        exit: vitest_1.vi.fn(),
                    };
                    return [4 /*yield*/, Promise.resolve().then(function () { return require("./doctor-state-migrations.js"); })];
                case 2:
                    _a = _b.sent(), detectLegacyStateMigrations = _a.detectLegacyStateMigrations, runLegacyStateMigrations = _a.runLegacyStateMigrations;
                    ...
                    confirm.mockClear();
                    return [4 /*yield*/, doctorCommand(runtime, { yes: true })];
                case 3:
                    _b.sent();
                    (0, vitest_1.expect)(runLegacyStateMigrations).toHaveBeenCalledTimes(1);
                    (0, vitest_1.expect)(confirm).not.toHaveBeenCalled();
                    return [2 /*return*/];
            }
        });
    }); }, 30000);
    (0, vitest_1.it)("skips gateway restarts in non-interactive mode", function () { return __awaiter(void 0, void 0, void 0, function () {
        var healthCommand, doctorCommand, runtime;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    readConfigFileSnapshot.mockResolvedValue({
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require("./health.js"); })];
                case 1:
                    healthCommand = (_a.sent()).healthCommand;
                ...
                case 3:
                    _a.sent();
                    (0, vitest_1.expect)(serviceRestart).not.toHaveBeenCalled();
                    (0, vitest_1.expect)(confirm).not.toHaveBeenCalled();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("migrates anthropic oauth config profile id when only email profile exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        var doctorCommand, written, profiles;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 1:
                    doctorCommand = (_b.sent()).doctorCommand;
                    return [4 /*yield*/, doctorCommand({ log: vitest_1.vi.fn(), error: vitest_1.vi.fn(), exit: vitest_1.vi.fn() }, { yes: true })];
                case 2:
                    _b.sent();
                    written = (_a = writeConfigFile.mock.calls.at(-1)) === null || _a === void 0 ? void 0 : _a[0];
                    profiles = written.auth.profiles;
                    (0, vitest_1.expect)(profiles["anthropic:me@example.com"]).toBeTruthy();
                    (0, vitest_1.expect)(profiles["anthropic:default"]).toBeUndefined();
                    return [2 /*return*/];
            }
        });
    }); }, 30000);
