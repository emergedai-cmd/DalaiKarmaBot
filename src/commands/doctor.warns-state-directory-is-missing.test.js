...
vitest_1.vi.mock("./doctor-update.js", function () { return ({
    maybeOfferUpdateBeforeDoctor: vitest_1.vi.fn().mockResolvedValue({ handled: false }),
}); });
(0, vitest_1.describe)("doctor command", function () {
    (0, vitest_1.it)("warns when the state directory is missing", function () { return __awaiter(void 0, void 0, void 0, function () {
        var missingDir, doctorCommand, stateNote;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    missingDir = node_fs_1.default.mkdtempSync(node_path_1.default.join(node_os_1.default.tmpdir(), "openclaw-missing-state-"));
                ...
                case 1:
                    ...
                    return [4 /*yield*/, doctorCommand({ log: vitest_1.vi.fn(), error: vitest_1.vi.fn(), exit: vitest_1.vi.fn() }, { nonInteractive: true, workspaceSuggestions: false })];
                case 2:
                    _a.sent();
                    stateNote = note.mock.calls.find(function (call) { return call[1] === "State integrity"; });
                    (0, vitest_1.expect)(stateNote).toBeTruthy();
                    (0, vitest_1.expect)(String(stateNote === null || stateNote === void 0 ? void 0 : stateNote[0])).toContain("CRITICAL");
                    return [2 /*return*/];
            }
        });
    }); }, 30000);
    (0, vitest_1.it)("warns about opencode provider overrides", function () { return __awaiter(void 0, void 0, void 0, function () {
        var doctorCommand, warned;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    readConfigFileSnapshot.mockResolvedValue({
                ...
                case 2:
                    _a.sent();
                    warned = note.mock.calls.some(function (_a) {
                        var message = _a[0], title = _a[1];
                        return title === "OpenCode Zen" && String(message).includes("models.providers.opencode");
                    });
    ...
    (0, vitest_1.it)("skips gateway auth warning when OPENCLAW_GATEWAY_TOKEN is set", function () { return __awaiter(void 0, void 0, void 0, function () {
        var prevToken, doctorCommand, warned;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    readConfigFileSnapshot.mockResolvedValue({
                ...
                case 5:
                    warned = note.mock.calls.some(function (_a) {
                        var message = _a[0];
                        return String(message).includes("Gateway auth is off or missing a token");
                    });
                    (0, vitest_1.expect)(warned).toBe(false);
                    return [2 /*return*/];
            }
        });
    }); });
