...
(0, vitest_1.describe)("doctor config flow", function () {
    (0, vitest_1.it)("preserves invalid config for doctor repairs", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, temp_home_js_1.withTempHome)(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var configDir, result;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                ...
                                case 3:
                                    result = _a.sent();
                                    (0, vitest_1.expect)(result.cfg.gateway).toEqual({
    ...
    (0, vitest_1.it)("drops unknown keys on repair", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, temp_home_js_1.withTempHome)(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var configDir, result, cfg;
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 3:
                                    result = _b.sent();
                                    cfg = result.cfg;
                                    (0, vitest_1.expect)(cfg.bridge).toBeUndefined();
                                    (0, vitest_1.expect)((_a = cfg.gateway) === null || _a === void 0 ? void 0 : _a.auth).toEqual({
                                        mode: "token",
                                        token: "ok",
                                    });
                                    return [2 /*return*/];
