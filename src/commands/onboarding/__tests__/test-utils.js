...
exports.makePrompter = exports.makeRuntime = void 0;
var vitest_1 = require("vitest");
var makeRuntime = function (overrides) {
    if (overrides === void 0) { overrides = {}; }
    return (__assign({ log: vitest_1.vi.fn(), error: vitest_1.vi.fn(), exit: vitest_1.vi.fn(function (code) {
            throw new Error("exit:".concat(code));
        }) }, overrides));
};
exports.makeRuntime = makeRuntime;
var makePrompter = function (overrides) {
    if (overrides === void 0) { overrides = {}; }
    return (__assign({ intro: vitest_1.vi.fn(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        ...
        }); }); }), progress: vitest_1.vi.fn(function () { return ({ update: vitest_1.vi.fn(), stop: vitest_1.vi.fn() }); }) }, overrides));
};
exports.makePrompter = makePrompter;
