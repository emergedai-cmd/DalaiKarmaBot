...
exports.runInteractiveOnboarding = runInteractiveOnboarding;
...
function runInteractiveOnboarding(opts_1) {
    return __awaiter(this, arguments, void 0, function (opts, runtime) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, onboarding_js_1.runOnboardingWizard)(opts, runtime, prompter)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
