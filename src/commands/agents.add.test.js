...
(0, vitest_1.describe)("agents add command", function () {
    ...
    (0, vitest_1.it)("requires --workspace when flags are present", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    configMocks.readConfigFileSnapshot.mockResolvedValue(__assign({}, baseSnapshot));
                    return [4 /*yield*/, (0, agents_js_1.agentsAddCommand)({ name: "Work" }, runtime, { hasFlags: true })];
                case 1:
                    _a.sent();
                    (0, vitest_1.expect)(runtime.error).toHaveBeenCalledWith(vitest_1.expect.stringContaining("--workspace"));
    ...
    (0, vitest_1.it)("requires --workspace in non-interactive mode", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    configMocks.readConfigFileSnapshot.mockResolvedValue(__assign({}, baseSnapshot));
                    return [4 /*yield*/, (0, agents_js_1.agentsAddCommand)({ name: "Work", nonInteractive: true }, runtime, {
                            hasFlags: false,
                        })];
                case 1:
                    _a.sent();
