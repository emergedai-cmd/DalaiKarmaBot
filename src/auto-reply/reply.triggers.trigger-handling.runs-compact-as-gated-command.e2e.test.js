...
(0, vitest_1.describe)("trigger handling", function () {
    (0, vitest_1.it)("runs /compact as a gated command", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var storePath, res, text, store, sessionKey;
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    storePath = (0, node_path_1.join)((0, node_os_1.tmpdir)(), "openclaw-session-test-".concat(Date.now(), ".json"));
                                    vitest_1.vi.mocked(pi_embedded_js_1.compactEmbeddedPiSession).mockResolvedValue({
                                        ok: true,
                                        compacted: true,
                                        result: {
                                            summary: "summary",
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(text === null || text === void 0 ? void 0 : text.startsWith("⚙️ Compacted")).toBe(true);
                                    (0, vitest_1.expect)(pi_embedded_js_1.compactEmbeddedPiSession).toHaveBeenCalledOnce();
                                    ...
                                    (0, vitest_1.expect)((_b = store[sessionKey]) === null || _b === void 0 ? void 0 : _b.compactionCount).toBe(1);
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("ignores think directives that only appear in the context wrapper", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text, prompt;
                        ...
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(prompt).toContain("Give me the status");
                                    (0, vitest_1.expect)(prompt).not.toContain("/thinking high");
    ...
    (0, vitest_1.it)("does not emit directive acks for heartbeats with /think", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text;
                            ...
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, (0, reply_js_1.getReplyFromConfig)({
                                            ...
                                            From: "+1003",
                                            To: "+1003",
                                        }, { isHeartbeat: true }, makeCfg(home))];
                                case 1:
                                    res = _b.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toBe("ok");
                                    (0, vitest_1.expect)(text).not.toMatch(/Thinking level set/i);
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).toHaveBeenCalledOnce();
                                    return [2 /*return*/];
                            }
                        });
