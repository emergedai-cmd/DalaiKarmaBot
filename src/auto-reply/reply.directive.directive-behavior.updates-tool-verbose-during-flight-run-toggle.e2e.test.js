...
(0, vitest_1.describe)("directive behavior", function () {
    ...
    (0, vitest_1.it)("updates tool verbose during an in-flight run (toggle on)", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var storePath, ctx, sessionKey, res, texts;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    storePath = node_path_1.default.join(home, "sessions.json");
                                    ctx = { Body: "please do the thing", From: "+1004", To: "+2000" };
                                    sessionKey = (0, sessions_js_1.resolveSessionKey)("per-sender", { From: ctx.From, To: ctx.To, Body: ctx.Body }, "main");
                                    vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mockImplementation(function (params) { return __awaiter(void 0, void 0, void 0, function () {
                                        var shouldEmit, store, entry;
                                        var _a;
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    shouldEmit = params.shouldEmitToolResult;
                                                    (0, vitest_1.expect)(shouldEmit === null || shouldEmit === void 0 ? void 0 : shouldEmit()).toBe(false);
                                                    store = (0, sessions_js_1.loadSessionStore)(storePath);
                                                    entry = (_a = store[sessionKey]) !== null && _a !== void 0 ? _a : {
                                                        sessionId: "s",
                                                        updatedAt: Date.now(),
                                                    };
                                                    store[sessionKey] = __assign(__assign({}, entry), { verboseLevel: "on", updatedAt: Date.now() });
                                                    return [4 /*yield*/, (0, sessions_js_1.saveSessionStore)(storePath, store)];
                                                case 1:
                                                    _b.sent();
                                                    (0, vitest_1.expect)(shouldEmit === null || shouldEmit === void 0 ? void 0 : shouldEmit()).toBe(true);
                                                    return [2 /*return*/, {
                                                            payloads: [{ text: "done" }],
                                                            meta: {
                                                                durationMs: 5,
                                    ...
                                    return [4 /*yield*/, (0, reply_js_1.getReplyFromConfig)(ctx, {}, {
                                            agents: {
                                                defaults: {
    ...
    (0, vitest_1.it)("updates tool verbose during an in-flight run (toggle off)", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var storePath, ctx, sessionKey, res, texts;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    ...
                                                    store[sessionKey] = __assign(__assign({}, entry), { verboseLevel: "off", updatedAt: Date.now() });
                                                    return [4 /*yield*/, (0, sessions_js_1.saveSessionStore)(storePath, store)];
                                                case 1:
                                                    _b.sent();
                                                    (0, vitest_1.expect)(shouldEmit === null || shouldEmit === void 0 ? void 0 : shouldEmit()).toBe(false);
                                    ...
                                    return [4 /*yield*/, (0, reply_js_1.getReplyFromConfig)({ Body: "/verbose on", From: ctx.From, To: ctx.To, CommandAuthorized: true }, {}, {
                                            agents: {
                                                defaults: {
                                                    model: "anthropic/claude-opus-4-5",
                                                    workspace: node_path_1.default.join(home, "openclaw"),
    ...
    (0, vitest_1.it)("shows summary on /model", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mockReset();
                                    storePath = node_path_1.default.join(home, "sessions.json");
                                    return [4 /*yield*/, (0, reply_js_1.getReplyFromConfig)({ Body: "/model", From: "+1222", To: "+1222", CommandAuthorized: true }, {}, {
                                            agents: {
                                                defaults: {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(text).toContain("Current: anthropic/claude-opus-4-5");
                                    (0, vitest_1.expect)(text).toContain("Switch: /model <provider/model>");
                                    (0, vitest_1.expect)(text).toContain("Browse: /models (providers) or /models <provider> (models)");
                                    (0, vitest_1.expect)(text).toContain("More: /model status");
                                    (0, vitest_1.expect)(text).not.toContain("openai/gpt-4.1-mini");
    ...
    (0, vitest_1.it)("lists allowlisted models on /model status", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var storePath, res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mockReset();
                                    storePath = node_path_1.default.join(home, "sessions.json");
                                    return [4 /*yield*/, (0, reply_js_1.getReplyFromConfig)({ Body: "/model status", From: "+1222", To: "+1222", CommandAuthorized: true }, {}, {
                                            agents: {
                                                defaults: {
                                                    model: { primary: "anthropic/claude-opus-4-5" },
                                                    workspace: node_path_1.default.join(home, "openclaw"),
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(text).toContain("openai/gpt-4.1-mini");
                                    (0, vitest_1.expect)(text).not.toContain("claude-sonnet-4-1");
                                    (0, vitest_1.expect)(text).toContain("auth:");
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).not.toHaveBeenCalled();
                                    return [2 /*return*/];
                            }
                        });
