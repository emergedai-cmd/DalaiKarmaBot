    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, (0, temp_home_js_1.withTempHome)(function (home) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, promises_1.mkdir)((0, node_path_1.join)(home, ".openclaw", "agents", "main", "sessions"), { recursive: true })];
                            case 1:
                                _a.sent();
...
(0, vitest_1.describe)("group intro prompts", function () {
    var groupParticipationNote = "Be a good group participant: mostly lurk and follow the conversation; reply only when directly addressed or you can add clear value. Emoji reactions are welcome when available. Write like a human. Avoid Markdown tables. Don't type literal \\n sequences; use real line breaks sparingly.";
    (0, vitest_1.it)("labels Discord groups using the surface metadata", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 1:
                                    ...
                                    extraSystemPrompt = (_c = (_b = (_a = vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mock.calls.at(-1)) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.extraSystemPrompt) !== null && _c !== void 0 ? _c : "";
                                    (0, vitest_1.expect)(extraSystemPrompt).toBe("You are replying inside the Discord group \"Release Squad\". Group members: Alice, Bob. Activation: trigger-only (you are invoked only when explicitly mentioned; recent context may be included). ".concat(groupParticipationNote, " Address the specific sender noted in the message context."));
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("keeps WhatsApp labeling for WhatsApp group chats", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var extraSystemPrompt;
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).toHaveBeenCalledOnce();
                                    extraSystemPrompt = (_c = (_b = (_a = vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mock.calls.at(-1)) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.extraSystemPrompt) !== null && _c !== void 0 ? _c : "";
                                    (0, vitest_1.expect)(extraSystemPrompt).toBe("You are replying inside the WhatsApp group \"Ops\". Activation: trigger-only (you are invoked only when explicitly mentioned; recent context may be included). WhatsApp IDs: SenderId is the participant JID; [message_id: ...] is the message id for reactions (use SenderId as participant). ".concat(groupParticipationNote, " Address the specific sender noted in the message context."));
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("labels Telegram groups using their own surface", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var extraSystemPrompt;
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).toHaveBeenCalledOnce();
                                    extraSystemPrompt = (_c = (_b = (_a = vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mock.calls.at(-1)) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.extraSystemPrompt) !== null && _c !== void 0 ? _c : "";
                                    (0, vitest_1.expect)(extraSystemPrompt).toBe("You are replying inside the Telegram group \"Dev Chat\". Activation: trigger-only (you are invoked only when explicitly mentioned; recent context may be included). ".concat(groupParticipationNote, " Address the specific sender noted in the message context."));
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
