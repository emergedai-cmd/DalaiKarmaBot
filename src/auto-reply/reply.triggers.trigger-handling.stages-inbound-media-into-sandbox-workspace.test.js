...
(0, vitest_1.describe)("stageSandboxMedia", function () {
    (0, vitest_1.it)("stages inbound media into the sandbox workspace", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var inboundDir, mediaPath, sandboxDir, ctx, sessionCtx, stagedPath, stagedFullPath;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    inboundDir = (0, node_path_1.join)(home, ".openclaw", "media", "inbound");
                                    return [4 /*yield*/, promises_1.default.mkdir(inboundDir, { recursive: true })];
                                case 1:
                                    _a.sent();
                                    mediaPath = (0, node_path_1.join)(inboundDir, "photo.jpg");
                                    return [4 /*yield*/, promises_1.default.writeFile(mediaPath, "test")];
                                case 2:
                                    _a.sent();
                                ...
                                case 3:
                                    _a.sent();
                                    stagedPath = "media/inbound/".concat((0, node_path_1.basename)(mediaPath));
                                    (0, vitest_1.expect)(ctx.MediaPath).toBe(stagedPath);
                                    (0, vitest_1.expect)(sessionCtx.MediaPath).toBe(stagedPath);
                                    (0, vitest_1.expect)(ctx.MediaUrl).toBe(stagedPath);
                                    (0, vitest_1.expect)(sessionCtx.MediaUrl).toBe(stagedPath);
                                    stagedFullPath = (0, node_path_1.join)(sandboxDir, "media", "inbound", (0, node_path_1.basename)(mediaPath));
                                    return [4 /*yield*/, (0, vitest_1.expect)(promises_1.default.stat(stagedFullPath)).resolves.toBeTruthy()];
                                case 4:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
