...
(0, vitest_1.describe)("directive behavior", function () {
    ...
    (0, vitest_1.it)("applies inline reasoning in mixed messages and acks immediately", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var blockReplies, storePath, res, texts;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
    ...
    (0, vitest_1.it)("keeps reasoning acks for rapid mixed directives", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var blockReplies, storePath;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mockResolvedValue({
    ...
    (0, vitest_1.it)("acks verbose directive immediately with system marker", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mockReset();
                                    return [4 /*yield*/, (0, reply_js_1.getReplyFromConfig)({ Body: "/verbose on", From: "+1222", To: "+1222", CommandAuthorized: true }, {}, {
                                            agents: {
                                                defaults: {
                                                    model: "anthropic/claude-opus-4-5",
                                                    workspace: node_path_1.default.join(home, "openclaw"),
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(text).toMatch(/^⚙️ Verbose logging enabled\./);
    ...
    (0, vitest_1.it)("persists verbose off when directive is standalone", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mockReset();
                                    storePath = node_path_1.default.join(home, "sessions.json");
                                    return [4 /*yield*/, (0, reply_js_1.getReplyFromConfig)({ Body: "/verbose off", From: "+1222", To: "+1222", CommandAuthorized: true }, {}, {
                                            agents: {
                                                defaults: {
                                                    model: "anthropic/claude-opus-4-5",
                                                    workspace: node_path_1.default.join(home, "openclaw"),
                                ...
                                case 1:
                                    res = _b.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toMatch(/Verbose logging disabled\./);
                                    store = (0, sessions_js_1.loadSessionStore)(storePath);
                                    entry = Object.values(store)[0];
                                    (0, vitest_1.expect)(entry === null || entry === void 0 ? void 0 : entry.verboseLevel).toBe("off");
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).not.toHaveBeenCalled();
                                    return [2 /*return*/];
                            }
                        });
    ...
    (0, vitest_1.it)("shows off when /think has no argument and no default set", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    res = _b.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toContain("Current thinking level: off");
                                    (0, vitest_1.expect)(text).toContain("Options: off, minimal, low, medium, high.");
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).not.toHaveBeenCalled();
                                    return [2 /*return*/];
                            }
