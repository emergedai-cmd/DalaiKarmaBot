...
(0, vitest_1.describe)("directive behavior", function () {
    ...
    (0, vitest_1.it)("shows current verbose level when /verbose has no argument", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mockReset();
                                    return [4 /*yield*/, (0, reply_js_1.getReplyFromConfig)({ Body: "/verbose", From: "+1222", To: "+1222", CommandAuthorized: true }, {}, {
                                            agents: {
                                                defaults: {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(text).toContain("Current verbose level: on");
                                    (0, vitest_1.expect)(text).toContain("Options: on, full, off.");
    ...
    (0, vitest_1.it)("shows current reasoning level when /reasoning has no argument", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mockReset();
                                    return [4 /*yield*/, (0, reply_js_1.getReplyFromConfig)({ Body: "/reasoning", From: "+1222", To: "+1222", CommandAuthorized: true }, {}, {
                                            agents: {
                                                defaults: {
                                                    model: "anthropic/claude-opus-4-5",
                                                    workspace: node_path_1.default.join(home, "openclaw"),
                                ...
                                case 1:
                                    res = _b.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toContain("Current reasoning level: off");
                                    (0, vitest_1.expect)(text).toContain("Options: on, off, stream.");
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).not.toHaveBeenCalled();
                                    return [2 /*return*/];
                            }
                        });
    ...
    (0, vitest_1.it)("shows current elevated level when /elevated has no argument", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    res = _b.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toContain("Current elevated level: on");
                                    (0, vitest_1.expect)(text).toContain("Options: on, off, ask, full.");
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).not.toHaveBeenCalled();
                                    return [2 /*return*/];
                            }
                        });
    ...
    (0, vitest_1.it)("shows current exec defaults when /exec has no argument", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    res = _b.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toContain("Current exec defaults: host=gateway, security=allowlist, ask=always, node=mac-1.");
                                    (0, vitest_1.expect)(text).toContain("Options: host=sandbox|gateway|node, security=deny|allowlist|full, ask=off|on-miss|always, node=<id>.");
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).not.toHaveBeenCalled();
                                    return [2 /*return*/];
                            }
                        });
    ...
    (0, vitest_1.it)("persists elevated off and reflects it in /status (even when default is on)", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)("strips inline elevated directives from the user text (does not persist session override)", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var storePath, store, calls, call;
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                ...
                                case 1:
                                    _c.sent();
                                    store = (0, sessions_js_1.loadSessionStore)(storePath);
                                    (0, vitest_1.expect)((_a = store["agent:main:main"]) === null || _a === void 0 ? void 0 : _a.elevatedLevel).toBeUndefined();
                                    calls = vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mock.calls;
                                    (0, vitest_1.expect)(calls.length).toBeGreaterThan(0);
                                    call = (_b = calls[0]) === null || _b === void 0 ? void 0 : _b[0];
                                    (0, vitest_1.expect)(call === null || call === void 0 ? void 0 : call.prompt).toContain("hello there");
                                    (0, vitest_1.expect)(call === null || call === void 0 ? void 0 : call.prompt).not.toContain("/elevated");
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
