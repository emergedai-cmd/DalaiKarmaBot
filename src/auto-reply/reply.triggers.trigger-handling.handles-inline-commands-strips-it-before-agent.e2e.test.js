...
(0, vitest_1.describe)("trigger handling", function () {
    (0, vitest_1.it)("handles inline /commands and strips it before the agent", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_f) {
                            switch (_f.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)((_b = blockReplies[0]) === null || _b === void 0 ? void 0 : _b.text).toContain("Slash commands");
                                    ...
                                    (0, vitest_1.expect)(prompt).not.toContain("/commands");
    ...
    (0, vitest_1.it)("handles inline /whoami and strips it before the agent", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var blockReplies, res, text, prompt;
                        ...
                        return __generator(this, function (_f) {
                            switch (_f.label) {
                                ...
                                case 1:
                                    ...
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(blockReplies.length).toBe(1);
                                    (0, vitest_1.expect)((_b = blockReplies[0]) === null || _b === void 0 ? void 0 : _b.text).toContain("Identity");
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).toHaveBeenCalled();
                                    prompt = (_e = (_d = (_c = vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mock.calls[0]) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.prompt) !== null && _e !== void 0 ? _e : "";
                                    (0, vitest_1.expect)(prompt).not.toContain("/whoami");
                                    (0, vitest_1.expect)(text).toBe("ok");
                                    return [2 /*return*/];
                            }
                        });
    ...
    (0, vitest_1.it)("drops /status for unauthorized senders", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, res;
    ...
    (0, vitest_1.it)("drops /whoami for unauthorized senders", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, res;
