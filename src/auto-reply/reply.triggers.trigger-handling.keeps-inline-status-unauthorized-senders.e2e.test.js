...
(0, vitest_1.describe)("trigger handling", function () {
    (0, vitest_1.it)("keeps inline /status for unauthorized senders", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, res, text, prompt;
                        var _a, _b, _c, _d;
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(prompt).toContain("/status");
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("keeps inline /help for unauthorized senders", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, res, text, prompt;
                        ...
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).toHaveBeenCalled();
                                    prompt = (_d = (_c = (_b = vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mock.calls[0]) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.prompt) !== null && _d !== void 0 ? _d : "";
                                    (0, vitest_1.expect)(prompt).toContain("/help");
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("returns help without invoking the agent", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(text).toContain("Shortcuts");
    ...
    (0, vitest_1.it)("allows owner to set send policy", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    res = _c.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toContain("Send policy set to off");
                                    return [4 /*yield*/, promises_1.default.readFile(cfg.session.store, "utf-8")];
                                case 2:
                                    storeRaw = _c.sent();
                                    store = JSON.parse(storeRaw);
                                    (0, vitest_1.expect)((_b = store[MAIN_SESSION_KEY]) === null || _b === void 0 ? void 0 : _b.sendPolicy).toBe("deny");
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
