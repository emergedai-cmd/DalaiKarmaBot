...
(0, vitest_1.describe)("directive behavior", function () {
    ...
    (0, vitest_1.it)("defaults /think to low for reasoning-capable models when no default set", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(text).toContain("Current thinking level: low");
    ...
    (0, vitest_1.it)("shows off when /think has no argument and model lacks reasoning", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text;
    ...
    (0, vitest_1.it)("strips reply tags and maps reply_to_current to MessageSid", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, payload;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(payload === null || payload === void 0 ? void 0 : payload.replyToId).toBe("msg-123");
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("strips reply tags with whitespace and maps reply_to_current to MessageSid", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, payload;
    ...
    (0, vitest_1.it)("prefers explicit reply_to id over reply_to_current", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, payload;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    res = _a.sent();
                                    payload = Array.isArray(res) ? res[0] : res;
                                    (0, vitest_1.expect)(payload === null || payload === void 0 ? void 0 : payload.text).toBe("hi");
                                    (0, vitest_1.expect)(payload === null || payload === void 0 ? void 0 : payload.replyToId).toBe("abc-456");
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("applies inline think and still runs agent content", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, texts;
