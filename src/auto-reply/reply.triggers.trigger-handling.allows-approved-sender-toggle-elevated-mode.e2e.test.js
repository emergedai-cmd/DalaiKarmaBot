...
(0, vitest_1.describe)("trigger handling", function () {
    (0, vitest_1.it)("allows approved sender to toggle elevated mode", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    (0, vitest_1.it)("rejects elevated toggles when disabled", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, res, text, storeRaw, store;
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    res = _c.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toContain("tools.elevated.enabled");
                                    return [4 /*yield*/, promises_1.default.readFile(cfg.session.store, "utf-8")];
                                case 2:
                                    storeRaw = _c.sent();
                                    store = JSON.parse(storeRaw);
                                    (0, vitest_1.expect)((_b = store[MAIN_SESSION_KEY]) === null || _b === void 0 ? void 0 : _b.elevatedLevel).toBeUndefined();
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("ignores elevated directive in groups when not mentioned", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(text).not.toContain("Elevated mode set to ask");
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
