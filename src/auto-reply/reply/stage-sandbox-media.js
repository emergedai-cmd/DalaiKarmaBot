...
var sandbox_paths_js_1 = require("../../agents/sandbox-paths.js");
            ...
            switch (_d.label) {
                ...
                case 1:
                    ...
                    remoteMediaCacheDir = ctx.MediaRemoteHost
                        ...
                        : null;
                    effectiveWorkspaceDir = (_c = sandbox === null || sandbox === void 0 ? void 0 : sandbox.workspaceDir) !== null && _c !== void 0 ? _c : remoteMediaCacheDir;
                ...
                case 3:
                    ...
                    _d.label = 4;
                case 4:
                    if (!(_i < rawPaths_1.length)) return [3 /*break*/, 14];
                    raw = rawPaths_1[_i];
                    ...
                    if (!!ctx.MediaRemoteHost) return [3 /*break*/, 8];
                    mediaDir = (0, store_js_1.getMediaDir)();
                    _d.label = 5;
                case 5:
                    _d.trys.push([5, 7, , 8]);
                ...
                case 7:
                    _a = _d.sent();
                    (0, globals_js_1.logVerbose)("Blocking attempt to stage media from outside media directory: ".concat(source));
                    return [3 /*break*/, 13];
                case 8:
                    ...
                    if (!ctx.MediaRemoteHost) return [3 /*break*/, 10];
                ...
                case 9:
                    ...
                    _d.sent();
                    return [3 /*break*/, 12];
                case 10: return [4 /*yield*/, promises_1.default.copyFile(source, dest)];
                case 11:
                    _d.sent();
                    _d.label = 12;
                case 12:
