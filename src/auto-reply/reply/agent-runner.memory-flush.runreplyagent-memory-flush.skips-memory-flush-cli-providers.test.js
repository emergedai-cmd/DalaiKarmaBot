...
(0, vitest_1.describe)("runReplyAgent memory flush", function () {
    (0, vitest_1.it)("skips memory flush for CLI providers", function () { return __awaiter(void 0, void 0, void 0, function () {
        var tmp, storePath, sessionKey, sessionEntry, calls, _a, typing, sessionCtx, resolvedQueue, followupRun, call;
        var _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    call = (_c = runCliAgentMock.mock.calls[0]) === null || _c === void 0 ? void 0 : _c[0];
