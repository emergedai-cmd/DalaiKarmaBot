...
function createRun(params) {
    ...
    return (0, agent_runner_js_1.runReplyAgent)({
        ...
        agentCfgContextTokens: params === null || params === void 0 ? void 0 : params.agentCfgContextTokens,
...
(0, vitest_1.describe)("runReplyAgent fallback reasoning tags", function () {
    (0, vitest_1.beforeEach)(function () {
        runEmbeddedPiAgentMock.mockReset();
        runWithModelFallbackMock.mockReset();
    });
    (0, vitest_1.it)("enforces <final> when the fallback provider requires reasoning tags", function () { return __awaiter(void 0, void 0, void 0, function () {
        var call;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                    ...
                    runWithModelFallbackMock.mockImplementationOnce(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
                                    _c = {};
                                    return [4 /*yield*/, run("google-antigravity", "gemini-3")];
                                case 1: return [2 /*return*/, (_c.result = _d.sent(),
                                        _c.provider = "google-antigravity",
                                        _c.model = "gemini-3",
                                        _c)];
                            }
                        });
                ...
                case 1:
                    _b.sent();
                    call = (_a = runEmbeddedPiAgentMock.mock.calls[0]) === null || _a === void 0 ? void 0 : _a[0];
                    (0, vitest_1.expect)(call === null || call === void 0 ? void 0 : call.enforceFinalTag).toBe(true);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("enforces <final> during memory flush on fallback providers", function () { return __awaiter(void 0, void 0, void 0, function () {
        var flushCall;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    runEmbeddedPiAgentMock.mockImplementation(function (params) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            ...
                            return [2 /*return*/, { payloads: [{ text: "ok" }], meta: {} }];
                        });
                    }); });
                    runWithModelFallbackMock.mockImplementation(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
                        var _c;
                        var run = _b.run;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                ...
                case 1:
                    _b.sent();
                    flushCall = (_a = runEmbeddedPiAgentMock.mock.calls.find(function (_a) {
                        var params = _a[0];
                        return (params === null || params === void 0 ? void 0 : params.prompt) === memory_flush_js_1.DEFAULT_MEMORY_FLUSH_PROMPT;
                    })) === null || _a === void 0 ? void 0 : _a[0];
                    (0, vitest_1.expect)(flushCall === null || flushCall === void 0 ? void 0 : flushCall.enforceFinalTag).toBe(true);
                    return [2 /*return*/];
            }
        });
    }); });
