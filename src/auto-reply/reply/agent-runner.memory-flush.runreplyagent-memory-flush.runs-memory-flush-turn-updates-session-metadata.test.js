...
(0, vitest_1.describe)("runReplyAgent memory flush", function () {
    (0, vitest_1.it)("runs a memory flush turn and updates session metadata", function () { return __awaiter(void 0, void 0, void 0, function () {
        var tmp, storePath, sessionKey, sessionEntry, calls, _a, typing, sessionCtx, resolvedQueue, followupRun, stored, _b, _c;
        var _d;
            ...
            switch (_e.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, agent_runner_js_1.runReplyAgent)({
                            ...
                            sessionCtx: sessionCtx,
                            sessionEntry: sessionEntry,
                            sessionStore: (_d = {}, _d[sessionKey] = sessionEntry, _d),
                ...
                case 3:
                    _e.sent();
                    (0, vitest_1.expect)(calls.map(function (call) { return call.prompt; })).toEqual([memory_flush_js_1.DEFAULT_MEMORY_FLUSH_PROMPT, "hello"]);
                    _c = (_b = JSON).parse;
                    return [4 /*yield*/, promises_1.default.readFile(storePath, "utf-8")];
                case 4:
                    stored = _c.apply(_b, [_e.sent()]);
                    (0, vitest_1.expect)(stored[sessionKey].memoryFlushAt).toBeTypeOf("number");
                    (0, vitest_1.expect)(stored[sessionKey].memoryFlushCompactionCount).toBe(1);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("skips memory flush when disabled in config", function () { return __awaiter(void 0, void 0, void 0, function () {
        var tmp, storePath, sessionKey, sessionEntry, _a, typing, sessionCtx, resolvedQueue, followupRun, call, stored, _b, _c;
        var _d;
        var _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    _f.sent();
                    runEmbeddedPiAgentMock.mockImplementation(function (_params) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, ({
                                    payloads: [{ text: "ok" }],
                                    meta: { agentMeta: { usage: { input: 1, output: 1 } } },
                ...
                case 3:
                    ...
                    call = (_e = runEmbeddedPiAgentMock.mock.calls[0]) === null || _e === void 0 ? void 0 : _e[0];
                    (0, vitest_1.expect)(call === null || call === void 0 ? void 0 : call.prompt).toBe("hello");
                    _c = (_b = JSON).parse;
                    return [4 /*yield*/, promises_1.default.readFile(storePath, "utf-8")];
                case 4:
                    stored = _c.apply(_b, [_f.sent()]);
                    (0, vitest_1.expect)(stored[sessionKey].memoryFlushAt).toBeUndefined();
                    return [2 /*return*/];
            }
        });
    }); });
