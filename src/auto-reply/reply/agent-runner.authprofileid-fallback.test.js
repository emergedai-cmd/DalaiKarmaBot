    ...
    runWithModelFallback: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _c = {};
                    return [4 /*yield*/, run("openai-codex", "gpt-5.2")];
                case 1: return [2 /*return*/, (
                    // Force a cross-provider fallback candidate
                    _c.result = _d.sent(),
                        _c.provider = "openai-codex",
                        _c.model = "gpt-5.2",
                        _c)];
            }
        });
...
function createBaseRun(params) {
    ...
    return {
        ...
        followupRun: __assign(__assign({}, followupRun), { run: __assign(__assign({}, followupRun.run), params.runOverrides) }),
    };
}
(0, vitest_1.describe)("authProfileId fallback scoping", function () {
    (0, vitest_1.it)("drops authProfileId when provider changes during fallback", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sessionKey, sessionEntry, _a, typing, sessionCtx, resolvedQueue, followupRun, call;
        var _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    call = (_c = runEmbeddedPiAgentMock.mock.calls[0]) === null || _c === void 0 ? void 0 : _c[0];
                    (0, vitest_1.expect)(call.provider).toBe("openai-codex");
                    (0, vitest_1.expect)(call.authProfileId).toBeUndefined();
                    (0, vitest_1.expect)(call.authProfileIdSource).toBeUndefined();
                    return [2 /*return*/];
            }
        });
    }); });
