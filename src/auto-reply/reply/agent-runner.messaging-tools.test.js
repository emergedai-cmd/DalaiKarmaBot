...
function createRun(messageProvider, opts) {
    var _a;
    if (messageProvider === void 0) { messageProvider = "slack"; }
    if (opts === void 0) { opts = {}; }
    var typing = (0, test_helpers_js_1.createMockTypingController)();
    var sessionKey = (_a = opts.sessionKey) !== null && _a !== void 0 ? _a : "main";
    var sessionCtx = {
...
(0, vitest_1.describe)("runReplyAgent messaging tool suppression", function () {
    (0, vitest_1.it)("drops replies when a messaging tool sent via the same provider + target", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createRun("slack")];
                case 1:
                    result = _a.sent();
    ...
    (0, vitest_1.it)("delivers replies when tool provider does not match", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    result = _a.sent();
                    (0, vitest_1.expect)(result).toMatchObject({ text: "hello world!" });
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("delivers replies when account ids do not match", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)("persists usage even when replies are suppressed", function () { return __awaiter(void 0, void 0, void 0, function () {
        var storePath, _a, _b, sessionKey, entry, result, store;
        var _c;
        var _d, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    return [4 /*yield*/, promises_1.default.mkdtemp(node_path_1.default.join(node_os_1.default.tmpdir(), "openclaw-session-store-"))];
                case 1:
                    storePath = _b.apply(_a, [_g.sent(), "sessions.json"]);
                    sessionKey = "main";
                    entry = { sessionId: "session", updatedAt: Date.now() };
                    return [4 /*yield*/, (0, sessions_js_1.saveSessionStore)(storePath, (_c = {}, _c[sessionKey] = entry, _c))];
                case 2:
                    _g.sent();
                    runEmbeddedPiAgentMock.mockResolvedValueOnce({
                        payloads: [{ text: "hello world!" }],
                    ...
                    return [4 /*yield*/, createRun("slack", { storePath: storePath, sessionKey: sessionKey })];
                case 3:
                    result = _g.sent();
                    (0, vitest_1.expect)(result).toBeUndefined();
