...
(0, vitest_1.describe)("runReplyAgent typing (heartbeat)", function () {
    (0, vitest_1.it)("signals typing for normal runs", function () { return __awaiter(void 0, void 0, void 0, function () {
        var onPartialReply, _a, run, typing;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    onPartialReply = vitest_1.vi.fn();
                    runEmbeddedPiAgentMock.mockImplementationOnce(function (params) { return __awaiter(void 0, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, ((_a = params.onPartialReply) === null || _a === void 0 ? void 0 : _a.call(params, { text: "hi" }))];
                                case 1:
                                    _b.sent();
                    ...
                    _a = createMinimalRun({
                        opts: { isHeartbeat: false, onPartialReply: onPartialReply },
                    }), run = _a.run, typing = _a.typing;
                    return [4 /*yield*/, run()];
                case 1:
                    _b.sent();
                    (0, vitest_1.expect)(onPartialReply).toHaveBeenCalled();
                    (0, vitest_1.expect)(typing.startTypingOnText).toHaveBeenCalledWith("hi");
                    (0, vitest_1.expect)(typing.startTypingLoop).toHaveBeenCalled();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("signals typing even without consumer partial handler", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, run, typing;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    (0, vitest_1.it)("never signals typing for heartbeat runs", function () { return __awaiter(void 0, void 0, void 0, function () {
        var onPartialReply, _a, run, typing;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = createMinimalRun({
                        opts: { isHeartbeat: true, onPartialReply: onPartialReply },
                    }), run = _a.run, typing = _a.typing;
                    return [4 /*yield*/, run()];
                case 1:
                    _b.sent();
    ...
    (0, vitest_1.it)("suppresses partial streaming for NO_REPLY", function () { return __awaiter(void 0, void 0, void 0, function () {
        var onPartialReply, _a, run, typing;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    runEmbeddedPiAgentMock.mockImplementationOnce(function (params) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, ((_a = params.onPartialReply) === null || _a === void 0 ? void 0 : _a.call(params, { text: "NO_REPLY" }))];
                                case 1:
                                    _b.sent();
                                    return [2 /*return*/, { payloads: [{ text: "NO_REPLY" }], meta: {} }];
                            }
                        });
                    }); });
                    _a = createMinimalRun({
    ...
    (0, vitest_1.it)("does not start typing on assistant message start without prior text in message mode", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, run, typing;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    runEmbeddedPiAgentMock.mockImplementationOnce(function (params) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, ((_a = params.onAssistantMessageStart) === null || _a === void 0 ? void 0 : _a.call(params))];
                                case 1:
                                    _b.sent();
                                    return [2 /*return*/, { payloads: [{ text: "final" }], meta: {} }];
                            }
    ...
    (0, vitest_1.it)("starts typing from reasoning stream in thinking mode", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, run, typing;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    runEmbeddedPiAgentMock.mockImplementationOnce(function (params) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0: return [4 /*yield*/, ((_a = params.onReasoningStream) === null || _a === void 0 ? void 0 : _a.call(params, { text: "Reasoning:\n_step_" }))];
                                case 1:
                                    _c.sent();
                                    return [4 /*yield*/, ((_b = params.onPartialReply) === null || _b === void 0 ? void 0 : _b.call(params, { text: "hi" }))];
                                case 2:
                                    _c.sent();
                                    return [2 /*return*/, { payloads: [{ text: "final" }], meta: {} }];
                            }
    ...
    (0, vitest_1.it)("suppresses typing in never mode", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, run, typing;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    runEmbeddedPiAgentMock.mockImplementationOnce(function (params) { return __awaiter(void 0, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            (_a = params.onPartialReply) === null || _a === void 0 ? void 0 : _a.call(params, { text: "hi" });
                            return [2 /*return*/, { payloads: [{ text: "final" }], meta: {} }];
                        });
                    }); });
                    _a = createMinimalRun({
