...
(0, vitest_1.describe)("runReplyAgent typing (heartbeat)", function () {
    (0, vitest_1.it)("still replies even if session reset fails to persist", function () { return __awaiter(void 0, void 0, void 0, function () {
        var prevStateDir, stateDir, saveSpy, sessionId, storePath, sessionEntry, sessionStore, transcriptPath, run, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    prevStateDir = process.env.OPENCLAW_STATE_DIR;
                    return [4 /*yield*/, promises_1.default.mkdtemp(node_path_1.default.join((0, node_os_1.tmpdir)(), "openclaw-session-reset-fail-"))];
                case 1:
                    stateDir = _a.sent();
                    process.env.OPENCLAW_STATE_DIR = stateDir;
                    saveSpy = vitest_1.vi.spyOn(sessions, "saveSessionStore").mockRejectedValueOnce(new Error("boom"));
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, , 7, 8]);
    ...
    (0, vitest_1.it)("rewrites Bun socket errors into friendly text", function () { return __awaiter(void 0, void 0, void 0, function () {
        var run, res, payloads;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                ...
                case 1:
                    res = _d.sent();
                    payloads = Array.isArray(res) ? res : res ? [res] : [];
                    (0, vitest_1.expect)(payloads.length).toBe(1);
                    (0, vitest_1.expect)((_a = payloads[0]) === null || _a === void 0 ? void 0 : _a.text).toContain("LLM connection failed");
                    (0, vitest_1.expect)((_b = payloads[0]) === null || _b === void 0 ? void 0 : _b.text).toContain("socket connection was closed unexpectedly");
                    (0, vitest_1.expect)((_c = payloads[0]) === null || _c === void 0 ? void 0 : _c.text).toContain("```");
                    return [2 /*return*/];
            }
        });
    }); });
