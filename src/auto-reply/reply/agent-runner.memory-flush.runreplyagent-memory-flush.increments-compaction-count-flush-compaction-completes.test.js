...
(0, vitest_1.describe)("runReplyAgent memory flush", function () {
    (0, vitest_1.it)("increments compaction count when flush compaction completes", function () { return __awaiter(void 0, void 0, void 0, function () {
        var tmp, storePath, sessionKey, sessionEntry, _a, typing, sessionCtx, resolvedQueue, followupRun, stored, _b, _c;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 4:
                    ...
                    (0, vitest_1.expect)(stored[sessionKey].compactionCount).toBe(2);
                    (0, vitest_1.expect)(stored[sessionKey].memoryFlushCompactionCount).toBe(2);
                    return [2 /*return*/];
            }
        });
    }); });
