...
(0, vitest_1.describe)("runReplyAgent block streaming", function () {
    (0, vitest_1.it)("coalesces duplicate text_end block replies", function () { return __awaiter(void 0, void 0, void 0, function () {
        var onBlockReply, typing, sessionCtx, resolvedQueue, followupRun, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    runEmbeddedPiAgentMock.mockImplementationOnce(function (params) { return __awaiter(void 0, void 0, void 0, function () {
                        var block;
                        return __generator(this, function (_a) {
                            block = params.onBlockReply;
                            block === null || block === void 0 ? void 0 : block({ text: "Hello" });
                            block === null || block === void 0 ? void 0 : block({ text: "Hello" });
                            return [2 /*return*/, {
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(onBlockReply.mock.calls[0][0].text).toBe("Hello");
