...
(0, vitest_1.describe)("trigger handling", function () {
    (0, vitest_1.it)("ignores inline elevated directive for unapproved sender", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    (0, vitest_1.expect)(text).not.toContain("elevated is not available right now");
    ...
    (0, vitest_1.it)("uses tools.elevated.allowFrom.discord for elevated approval", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, res, text, storeRaw, store;
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 2:
                                    ...
                                    (0, vitest_1.expect)((_b = store[MAIN_SESSION_KEY]) === null || _b === void 0 ? void 0 : _b.elevatedLevel).toBe("on");
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("treats explicit discord elevated allowlist as override", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    res = _b.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toContain("tools.elevated.allowFrom.discord");
    ...
    (0, vitest_1.it)("returns a context overflow fallback when the embedded agent throws", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mockRejectedValue(new Error("Context window exceeded"));
                                    return [4 /*yield*/, (0, reply_js_1.getReplyFromConfig)({
                                            Body: "hello",
                                            From: "+1002",
                                            To: "+2000",
                                ...
                                case 1:
                                    res = _b.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toBe("⚠️ Context overflow — prompt too large for this model. Try a shorter message or a larger-context model.");
