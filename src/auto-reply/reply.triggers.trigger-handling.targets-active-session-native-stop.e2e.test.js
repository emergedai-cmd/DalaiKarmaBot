...
(0, vitest_1.describe)("trigger handling", function () {
    (0, vitest_1.it)("targets the active session for native /stop", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, targetSessionKey, targetSessionId, followupRun, res, text, store;
                        var _a;
                        var _b, _c;
                            ...
                            switch (_d.label) {
                                ...
                                case 1:
                                    ...
                                    followupRun = {
                                        ...
                                        run: {
                                            agentId: "main",
                                            agentDir: (0, node_path_1.join)(home, "agent"),
                                            sessionId: targetSessionId,
                                            sessionKey: targetSessionKey,
                                            messageProvider: "telegram",
                                            agentAccountId: "acct",
                                            sessionFile: (0, node_path_1.join)(home, "session.jsonl"),
                                            workspaceDir: (0, node_path_1.join)(home, "workspace"),
                                            config: cfg,
                                            provider: "anthropic",
                                    ...
                                    (0, queue_js_1.enqueueFollowupRun)(targetSessionKey, followupRun, { mode: "collect", debounceMs: 0, cap: 20, dropPolicy: "summarize" }, "none");
                                    (0, vitest_1.expect)((0, queue_js_1.getFollowupQueueDepth)(targetSessionKey)).toBe(1);
                                ...
                                case 2:
                                    ...
                                    (0, vitest_1.expect)(vitest_1.vi.mocked(pi_embedded_js_1.abortEmbeddedPiRun)).toHaveBeenCalledWith(targetSessionId);
                                    store = (0, sessions_js_1.loadSessionStore)(cfg.session.store);
                                    (0, vitest_1.expect)((_c = store[targetSessionKey]) === null || _c === void 0 ? void 0 : _c.abortedLastRun).toBe(true);
                                    (0, vitest_1.expect)((0, queue_js_1.getFollowupQueueDepth)(targetSessionKey)).toBe(0);
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("applies native /model to the target session", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, slashSessionKey, targetSessionKey, res, text, store;
                        var _a;
                        var _b, _c, _d, _e;
                        return __generator(this, function (_f) {
                            switch (_f.label) {
                                ...
                                case 2:
                                    res = _f.sent();
                                    text = Array.isArray(res) ? (_b = res[0]) === null || _b === void 0 ? void 0 : _b.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toContain("Model set to openai/gpt-4.1-mini");
                                    store = (0, sessions_js_1.loadSessionStore)(cfg.session.store);
                                    (0, vitest_1.expect)((_c = store[targetSessionKey]) === null || _c === void 0 ? void 0 : _c.providerOverride).toBe("openai");
                                    (0, vitest_1.expect)((_d = store[targetSessionKey]) === null || _d === void 0 ? void 0 : _d.modelOverride).toBe("gpt-4.1-mini");
                                    (0, vitest_1.expect)(store[slashSessionKey]).toBeUndefined();
                                ...
                                case 3:
                                    ...
                                    (0, vitest_1.expect)((_e = vitest_1.vi.mocked(pi_embedded_js_1.runEmbeddedPiAgent).mock.calls[0]) === null || _e === void 0 ? void 0 : _e[0]).toEqual(vitest_1.expect.objectContaining({
                                        provider: "openai",
                                        model: "gpt-4.1-mini",
                                    }));
                                    return [2 /*return*/];
    ...
    (0, vitest_1.it)("uses the target agent model for native /status", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var cfg, res, text;
