...
(0, vitest_1.describe)("directive behavior", function () {
    ...
    (0, vitest_1.it)("shows current elevated level as off after toggling it off", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 2:
                                    ...
                                    (0, vitest_1.expect)(text).toContain("Current elevated level: off");
    ...
    (0, vitest_1.it)("can toggle elevated off then back on (status reflects on)", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var storePath, cfg, res, text, optionsLine, store;
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 3:
                                    ...
                                    (0, vitest_1.expect)(optionsLine).toContain("elevated");
                                    store = (0, sessions_js_1.loadSessionStore)(storePath);
                                    (0, vitest_1.expect)((_b = store["agent:main:main"]) === null || _b === void 0 ? void 0 : _b.elevatedLevel).toBe("on");
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).not.toHaveBeenCalled();
                                    return [2 /*return*/];
                            }
                        });
    ...
    (0, vitest_1.it)("rejects per-agent elevated when disabled", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var res, text;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    res = _b.sent();
                                    text = Array.isArray(res) ? (_a = res[0]) === null || _a === void 0 ? void 0 : _a.text : res === null || res === void 0 ? void 0 : res.text;
                                    (0, vitest_1.expect)(text).toContain("agents.list[].tools.elevated.enabled");
                                    (0, vitest_1.expect)(pi_embedded_js_1.runEmbeddedPiAgent).not.toHaveBeenCalled();
                                    return [2 /*return*/];
                            }
                        });
