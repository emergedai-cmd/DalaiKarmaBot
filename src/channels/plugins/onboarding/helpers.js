...
exports.promptAccountId = void 0;
exports.addWildcardAllowFrom = addWildcardAllowFrom;
var session_key_js_1 = require("../../../routing/session-key.js");
var promptAccountId = function (params) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                initial = ((_a = params.currentId) === null || _a === void 0 ? void 0 : _a.trim()) || params.defaultAccountId || session_key_js_1.DEFAULT_ACCOUNT_ID;
            ...
            case 2:
                entered = _b.sent();
                normalized = (0, session_key_js_1.normalizeAccountId)(String(entered));
...
function addWildcardAllowFrom(allowFrom) {
    var next = (allowFrom !== null && allowFrom !== void 0 ? allowFrom : []).map(function (v) { return String(v).trim(); }).filter(Boolean);
    if (!next.includes("*")) {
        next.push("*");
    }
    return next;
