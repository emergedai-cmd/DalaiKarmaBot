...
exports.slackOutbound = void 0;
var send_js_1 = require("../../../slack/send.js");
exports.slackOutbound = {
    deliveryMode: "direct",
    chunker: null,
    textChunkLimit: 4000,
    sendText: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var send, threadTs, result;
        var _c;
        var to = _b.to, text = _b.text, accountId = _b.accountId, deps = _b.deps, replyToId = _b.replyToId, threadId = _b.threadId;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    send = (_c = deps === null || deps === void 0 ? void 0 : deps.sendSlack) !== null && _c !== void 0 ? _c : send_js_1.sendMessageSlack;
                    threadTs = replyToId !== null && replyToId !== void 0 ? replyToId : (threadId != null ? String(threadId) : undefined);
