...
exports.imessageOutbound = void 0;
var chunk_js_1 = require("../../../auto-reply/chunk.js");
var send_js_1 = require("../../../imessage/send.js");
var media_limits_js_1 = require("../media-limits.js");
exports.imessageOutbound = {
    deliveryMode: "direct",
    ...
    sendText: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    send = (_c = deps === null || deps === void 0 ? void 0 : deps.sendIMessage) !== null && _c !== void 0 ? _c : send_js_1.sendMessageIMessage;
                    maxBytes = (0, media_limits_js_1.resolveChannelMediaMaxBytes)({
                        cfg: cfg,
