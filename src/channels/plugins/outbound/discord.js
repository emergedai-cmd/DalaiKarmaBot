...
exports.discordOutbound = void 0;
var send_js_1 = require("../../../discord/send.js");
exports.discordOutbound = {
    deliveryMode: "direct",
    chunker: null,
    textChunkLimit: 2000,
    pollMaxOptions: 10,
    sendText: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    send = (_c = deps === null || deps === void 0 ? void 0 : deps.sendDiscord) !== null && _c !== void 0 ? _c : send_js_1.sendMessageDiscord;
    ...
    sendPoll: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, send_js_1.sendPollDiscord)(to, poll, {
                        accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                    })];
