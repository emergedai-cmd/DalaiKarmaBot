...
(0, vitest_1.describe)("slack actions adapter", function () {
    (0, vitest_1.it)("forwards threadId for read", function () { return __awaiter(void 0, void 0, void 0, function () {
        var cfg, actions, params;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    cfg = { channels: { slack: { botToken: "tok" } } };
                    actions = (0, slack_actions_js_1.createSlackActions)("slack");
                    return [4 /*yield*/, ((_a = actions.handleAction) === null || _a === void 0 ? void 0 : _a.call(actions, {
                            channel: "slack",
                            action: "read",
                            cfg: cfg,
                            params: {
                ...
                case 1:
                    _c.sent();
                    params = ((_b = handleSlackAction.mock.calls[0]) !== null && _b !== void 0 ? _b : [])[0];
