...
(0, vitest_1.describe)("browser control server", function () {
    ...
    (0, vitest_1.it)("agent contract: snapshot endpoints", function () { return __awaiter(void 0, void 0, void 0, function () {
        var base, snapAria, snapAi;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, startServerAndBase()];
                case 1:
                    base = _a.sent();
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/snapshot?format=aria&limit=1")).then(function (r) {
                            return r.json();
                        })];
                case 2:
                    snapAria = (_a.sent());
                    (0, vitest_1.expect)(snapAria.ok).toBe(true);
                    (0, vitest_1.expect)(snapAria.format).toBe("aria");
                    (0, vitest_1.expect)(cdpMocks.snapshotAria).toHaveBeenCalledWith({
                        wsUrl: "ws://127.0.0.1/devtools/page/abcd1234",
                        limit: 1,
                    });
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/snapshot?format=ai")).then(function (r) { return r.json(); })];
                case 3:
                    snapAi = (_a.sent());
                    (0, vitest_1.expect)(snapAi.ok).toBe(true);
                    (0, vitest_1.expect)(snapAi.format).toBe("ai");
                    (0, vitest_1.expect)(pwMocks.snapshotAiViaPlaywright).toHaveBeenCalledWith({
                        cdpUrl: cdpBaseUrl,
                        targetId: "abcd1234",
    ...
    (0, vitest_1.it)("agent contract: navigation + common act commands", function () { return __awaiter(void 0, void 0, void 0, function () {
        var base, nav, click, clickSelector, _a, type, press, hover, scroll, drag;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, startServerAndBase()];
                case 1:
                    base = _b.sent();
                    return [4 /*yield*/, postJson("".concat(base, "/navigate"), {
                            url: "https://example.com",
                        })];
                case 2:
                    nav = _b.sent();
                    (0, vitest_1.expect)(nav.ok).toBe(true);
                    (0, vitest_1.expect)(typeof nav.targetId).toBe("string");
                    (0, vitest_1.expect)(pwMocks.navigateViaPlaywright).toHaveBeenCalledWith({
                        cdpUrl: cdpBaseUrl,
                        targetId: "abcd1234",
                        url: "https://example.com",
                    });
                ...
                case 3:
                    click = _b.sent();
                    (0, vitest_1.expect)(click.ok).toBe(true);
                    (0, vitest_1.expect)(pwMocks.clickViaPlaywright).toHaveBeenNthCalledWith(1, {
                        cdpUrl: cdpBaseUrl,
                        targetId: "abcd1234",
                        ref: "1",
                        doubleClick: false,
                ...
                case 4:
                    clickSelector = _b.sent();
                    (0, vitest_1.expect)(clickSelector.status).toBe(400);
                    _a = vitest_1.expect;
                    return [4 /*yield*/, clickSelector.json()];
                case 5:
                    _a.apply(void 0, [(_b.sent()).error]).toMatch(/'selector' is not supported/i);
                    return [4 /*yield*/, postJson("".concat(base, "/act"), {
                            kind: "type",
                            ref: "1",
                            text: "",
                ...
                case 6:
                    type = _b.sent();
                    (0, vitest_1.expect)(type.ok).toBe(true);
                    (0, vitest_1.expect)(pwMocks.typeViaPlaywright).toHaveBeenNthCalledWith(1, {
                        cdpUrl: cdpBaseUrl,
                        targetId: "abcd1234",
                        ref: "1",
                        text: "",
                ...
                case 7:
                    press = _b.sent();
                    (0, vitest_1.expect)(press.ok).toBe(true);
                    (0, vitest_1.expect)(pwMocks.pressKeyViaPlaywright).toHaveBeenCalledWith({
                        cdpUrl: cdpBaseUrl,
                        targetId: "abcd1234",
                        key: "Enter",
                    });
                ...
                case 8:
                    hover = _b.sent();
                    (0, vitest_1.expect)(hover.ok).toBe(true);
                    (0, vitest_1.expect)(pwMocks.hoverViaPlaywright).toHaveBeenCalledWith({
                        cdpUrl: cdpBaseUrl,
                        targetId: "abcd1234",
                        ref: "2",
                    });
                ...
                case 9:
                    scroll = _b.sent();
                    (0, vitest_1.expect)(scroll.ok).toBe(true);
                    (0, vitest_1.expect)(pwMocks.scrollIntoViewViaPlaywright).toHaveBeenCalledWith({
                        cdpUrl: cdpBaseUrl,
                        targetId: "abcd1234",
                        ref: "2",
                    });
                ...
                case 10:
                    drag = _b.sent();
                    (0, vitest_1.expect)(drag.ok).toBe(true);
                    (0, vitest_1.expect)(pwMocks.dragViaPlaywright).toHaveBeenCalledWith({
                        cdpUrl: cdpBaseUrl,
                        targetId: "abcd1234",
                        startRef: "3",
                        endRef: "4",
