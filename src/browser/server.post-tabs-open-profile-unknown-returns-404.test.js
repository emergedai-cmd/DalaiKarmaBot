...
(0, vitest_1.describe)("browser control server", function () {
    ...
    (0, vitest_1.it)("POST /tabs/open?profile=unknown returns 404", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/tabs/open?profile=unknown"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
...
(0, vitest_1.describe)("profile CRUD endpoints", function () {
    (0, vitest_1.beforeEach)(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)("POST /profiles/create returns 400 for missing name", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, result, body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                ...
                case 2:
                    _a.sent();
                    base = "http://127.0.0.1:".concat(testPort);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/profiles/create"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({}),
                        })];
                ...
                case 4:
                    body = (_a.sent());
                    (0, vitest_1.expect)(body.error).toContain("name is required");
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("POST /profiles/create returns 400 for invalid name format", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, result, body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                ...
                case 4:
                    body = (_a.sent());
                    (0, vitest_1.expect)(body.error).toContain("invalid profile name");
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("POST /profiles/create returns 409 for duplicate name", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, result, body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                ...
                case 3:
                    result = _a.sent();
                    (0, vitest_1.expect)(result.status).toBe(409);
                    return [4 /*yield*/, result.json()];
                case 4:
                    body = (_a.sent());
                    (0, vitest_1.expect)(body.error).toContain("already exists");
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("POST /profiles/create accepts cdpUrl for remote profiles", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, result, body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                ...
                case 4:
                    body = (_a.sent());
                    (0, vitest_1.expect)(body.profile).toBe("remote");
                    (0, vitest_1.expect)(body.cdpUrl).toBe("http://10.0.0.42:9222");
                    (0, vitest_1.expect)(body.isRemote).toBe(true);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("POST /profiles/create returns 400 for invalid cdpUrl", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, result, body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                ...
                case 4:
                    body = (_a.sent());
                    (0, vitest_1.expect)(body.error).toContain("cdpUrl");
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("DELETE /profiles/:name returns 404 for non-existent profile", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, result, body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                ...
                case 2:
                    _a.sent();
                    base = "http://127.0.0.1:".concat(testPort);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/profiles/nonexistent"), {
                            method: "DELETE",
                        })];
                case 3:
                    result = _a.sent();
    ...
    (0, vitest_1.it)("DELETE /profiles/:name returns 400 for default profile deletion", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, result, body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                ...
                case 2:
                    _a.sent();
                    base = "http://127.0.0.1:".concat(testPort);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/profiles/openclaw"), {
                            method: "DELETE",
                        })];
                case 3:
                    result = _a.sent();
                ...
                case 4:
                    body = (_a.sent());
                    (0, vitest_1.expect)(body.error).toContain("cannot delete the default profile");
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("DELETE /profiles/:name returns 400 for invalid name format", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, result, body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                ...
                case 2:
                    _a.sent();
                    base = "http://127.0.0.1:".concat(testPort);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/profiles/Invalid-Name!"), {
                            method: "DELETE",
                        })];
                case 3:
                    result = _a.sent();
