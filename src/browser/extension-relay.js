...
exports.getChromeExtensionRelayAuthHeaders = getChromeExtensionRelayAuthHeaders;
...
function relayAuthTokenForUrl(url) {
    ...
    try {
        ...
        var port = ((_a = parsed.port) === null || _a === void 0 ? void 0 : _a.trim()) !== ""
            ? Number(parsed.port)
        ...
        return (_b = relayAuthByPort.get(port)) !== null && _b !== void 0 ? _b : null;
    }
    catch (_c) {
        return null;
    }
...
function getChromeExtensionRelayAuthHeaders(url) {
    var _a;
    var token = relayAuthTokenForUrl(url);
    if (!token) {
        return {};
    }
    return _a = {}, _a[RELAY_AUTH_HEADER] = token, _a;
}
function ensureChromeExtensionRelayServer(opts) {
    return __awaiter(this, void 0, void 0, function () {
        var info, existing, extensionWs, cdpClients, connectedTargets, pendingExtension, nextExtensionId, sendToExtension, broadcastToCdpClients, sendResponseToCdp, ensureTargetEventsForClient, routeCdpCommand, relayAuthToken, server, wssExtension, wssCdp, addr, port, host, baseUrl, relay;
        var _this = this;
        var _a;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    server.on("upgrade", function (req, socket, head) {
                        ...
                        var origin = headerValue(req.headers.origin);
