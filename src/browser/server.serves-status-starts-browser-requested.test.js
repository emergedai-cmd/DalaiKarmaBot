...
(0, vitest_1.describe)("browser control server", function () {
    ...
    (0, vitest_1.it)("serves status + starts browser when requested", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, started, base, s1, s2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    started = _a.sent();
                    (0, vitest_1.expect)(started === null || started === void 0 ? void 0 : started.port).toBe(testPort);
                    base = "http://127.0.0.1:".concat(testPort);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/")).then(function (r) { return r.json(); })];
                case 3:
                    s1 = (_a.sent());
                    (0, vitest_1.expect)(s1.running).toBe(false);
                    (0, vitest_1.expect)(s1.pid).toBe(null);
                ...
                case 5:
                    s2 = (_a.sent());
                    (0, vitest_1.expect)(s2.running).toBe(true);
                    (0, vitest_1.expect)(s2.pid).toBe(123);
                    (0, vitest_1.expect)(s2.chosenBrowser).toBe("chrome");
                    (0, vitest_1.expect)(launchCalls.length).toBeGreaterThan(0);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("handles tabs: list, open, focus conflict on ambiguous prefix", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, tabs, opened, focus;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                case 1:
                ...
                case 4:
                    tabs = (_a.sent());
                    (0, vitest_1.expect)(tabs.running).toBe(true);
                    (0, vitest_1.expect)(tabs.tabs.length).toBeGreaterThan(0);
                ...
                case 5:
                    opened = _a.sent();
                    (0, vitest_1.expect)(opened).toMatchObject({ targetId: "newtab1" });
                ...
                case 6:
                    focus = _a.sent();
                    (0, vitest_1.expect)(focus.status).toBe(409);
                    return [2 /*return*/];
            }
        });
    }); });
