...
function findPageByTargetId(browser, targetId, cdpUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var pages, _i, pages_1, page, tid, baseUrl, listUrl, response, targets, target_1, urlMatch, sameUrlTargets, idx, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    ...
                    baseUrl = cdpUrl
                        ...
                        .replace(/^ws:/, "http:")
                        .replace(/\/cdp$/, "");
                    listUrl = "".concat(baseUrl, "/json/list");
                    return [4 /*yield*/, fetch(listUrl, { headers: (0, cdp_helpers_js_1.getHeadersWithAuth)(listUrl) })];
                case 7:
                    response = _b.sent();
