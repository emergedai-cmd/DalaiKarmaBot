...
(0, vitest_1.describe)("browser control server", function () {
    ...
    (0, vitest_1.it)("skips default maxChars when explicitly set to zero", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, snapAi, call;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                case 1:
                    startBrowserControlServerFromConfig = (_b.sent()).startBrowserControlServerFromConfig;
                ...
                case 3:
                    _b.sent();
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/snapshot?format=ai&maxChars=0")).then(function (r) {
                            return r.json();
                        })];
                case 4:
                    snapAi = (_b.sent());
                    (0, vitest_1.expect)(snapAi.ok).toBe(true);
                    (0, vitest_1.expect)(snapAi.format).toBe("ai");
                    call = ((_a = pwMocks.snapshotAiViaPlaywright.mock.calls.at(-1)) !== null && _a !== void 0 ? _a : [])[0];
    ...
    (0, vitest_1.it)("validates agent inputs (agent routes)", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, navMissing, actMissing, clickMissingRef, scrollMissingRef, scrollSelectorUnsupported, clickBadButton, clickBadModifiers, typeBadText, uploadMissingPaths, dialogMissingAccept, snapDefault, screenshotBadCombo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                case 1:
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/navigate"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({}),
                        })];
                case 4:
                    navMissing = _a.sent();
                    (0, vitest_1.expect)(navMissing.status).toBe(400);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/act"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({}),
                        })];
                case 5:
                    actMissing = _a.sent();
                    (0, vitest_1.expect)(actMissing.status).toBe(400);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/act"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                ...
                case 6:
                    clickMissingRef = _a.sent();
                    (0, vitest_1.expect)(clickMissingRef.status).toBe(400);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/act"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                ...
                case 7:
                    scrollMissingRef = _a.sent();
                    (0, vitest_1.expect)(scrollMissingRef.status).toBe(400);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/act"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                ...
                case 8:
                    scrollSelectorUnsupported = _a.sent();
                    (0, vitest_1.expect)(scrollSelectorUnsupported.status).toBe(400);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/act"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                ...
                case 9:
                    clickBadButton = _a.sent();
                    (0, vitest_1.expect)(clickBadButton.status).toBe(400);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/act"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                ...
                case 10:
                    clickBadModifiers = _a.sent();
                    (0, vitest_1.expect)(clickBadModifiers.status).toBe(400);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/act"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                ...
                case 11:
                    typeBadText = _a.sent();
                    (0, vitest_1.expect)(typeBadText.status).toBe(400);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/hooks/file-chooser"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({}),
                        })];
                case 12:
                    uploadMissingPaths = _a.sent();
                    (0, vitest_1.expect)(uploadMissingPaths.status).toBe(400);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/hooks/dialog"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({}),
                        })];
                case 13:
                    dialogMissingAccept = _a.sent();
                    (0, vitest_1.expect)(dialogMissingAccept.status).toBe(400);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/snapshot?format=wat")).then(function (r) { return r.json(); })];
                case 14:
                    snapDefault = (_a.sent());
                    (0, vitest_1.expect)(snapDefault.ok).toBe(true);
                    (0, vitest_1.expect)(snapDefault.format).toBe("ai");
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/screenshot"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({ fullPage: true, element: "body" }),
                        })];
                case 15:
                    screenshotBadCombo = _a.sent();
                    (0, vitest_1.expect)(screenshotBadCombo.status).toBe(400);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("covers common error branches", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, missing, started;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 3:
                    missing = _b.sent();
                    (0, vitest_1.expect)(missing.status).toBe(400);
                    reachable = false;
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(base, "/start"), {
                            method: "POST",
                        }).then(function (r) { return r.json(); })];
                case 4:
                    started = (_b.sent());
                    (0, vitest_1.expect)((_a = started.error) !== null && _a !== void 0 ? _a : "").toMatch(/attachOnly/i);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)("allows attachOnly servers to ensure reachability via callback", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserBridgeServer, ensured, bridge, started, status;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cfgAttachOnly = true;
                    reachable = false;
                    return [4 /*yield*/, Promise.resolve().then(function () { return require("./bridge-server.js"); })];
                case 1:
                    startBrowserBridgeServer = (_a.sent()).startBrowserBridgeServer;
                    ensured = vitest_1.vi.fn(function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            reachable = true;
                            return [2 /*return*/];
                        });
                    }); });
                    return [4 /*yield*/, startBrowserBridgeServer({
                            resolved: {
                                enabled: true,
                                controlPort: 0,
                                cdpProtocol: "http",
                ...
                case 2:
                    bridge = _a.sent();
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(bridge.baseUrl, "/start"), {
                            method: "POST",
                        }).then(function (r) { return r.json(); })];
                case 3:
                    started = (_a.sent());
                    (0, vitest_1.expect)(started.error).toBeUndefined();
                    (0, vitest_1.expect)(started.ok).toBe(true);
                    return [4 /*yield*/, (0, undici_1.fetch)("".concat(bridge.baseUrl, "/")).then(function (r) { return r.json(); })];
                case 4:
                    status = (_a.sent());
                    (0, vitest_1.expect)(status.running).toBe(true);
                    (0, vitest_1.expect)(ensured).toHaveBeenCalledTimes(1);
                    return [4 /*yield*/, new Promise(function (resolve) { return bridge.server.close(function () { return resolve(); }); })];
                case 5:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    (0, vitest_1.it)("opens tabs via CDP createTarget path", function () { return __awaiter(void 0, void 0, void 0, function () {
        var startBrowserControlServerFromConfig, base, opened;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./server.js"); })];
                case 1:
                ...
                case 4:
                    opened = (_a.sent());
                    (0, vitest_1.expect)(opened.targetId).toBe("abcd1234");
                    return [2 /*return*/];
            }
        });
    }); });
