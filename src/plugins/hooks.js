...
function getHooksForName(registry, hookName) {
    return registry.typedHooks
        ...
        .toSorted(function (a, b) { var _a, _b; return ((_a = b.priority) !== null && _a !== void 0 ? _a : 0) - ((_b = a.priority) !== null && _b !== void 0 ? _b : 0); });
}
/**
                                ...
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        if (catchErrors) {
                                            ...
                                            throw new Error(msg, { cause: err_1 });
                                        }
                                        return [3 /*break*/, 3];
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        if (catchErrors) {
                            ...
                            throw new Error(msg, { cause: err_2 });
                        }
                        return [3 /*break*/, 5];
                    case 5:
                        _i++;
