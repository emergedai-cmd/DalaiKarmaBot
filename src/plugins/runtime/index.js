...
var monitor_js_3 = require("../../line/monitor.js");
var probe_js_3 = require("../../line/probe.js");
var send_js_3 = require("../../line/send.js");
...
var probe_js_4 = require("../../signal/probe.js");
var send_js_4 = require("../../signal/send.js");
var directory_live_js_2 = require("../../slack/directory-live.js");
var index_js_3 = require("../../slack/index.js");
var probe_js_5 = require("../../slack/probe.js");
var resolve_channels_js_2 = require("../../slack/resolve-channels.js");
var resolve_users_js_2 = require("../../slack/resolve-users.js");
var send_js_5 = require("../../slack/send.js");
var audit_js_2 = require("../../telegram/audit.js");
var monitor_js_4 = require("../../telegram/monitor.js");
var probe_js_6 = require("../../telegram/probe.js");
var send_js_6 = require("../../telegram/send.js");
    ...
    return {
        ...
        channel: {
            ...
            slack: {
                ...
                probeSlack: probe_js_5.probeSlack,
                ...
                sendMessageSlack: send_js_5.sendMessageSlack,
            ...
            telegram: {
                ...
                probeTelegram: probe_js_6.probeTelegram,
                resolveTelegramToken: token_js_1.resolveTelegramToken,
                sendMessageTelegram: send_js_6.sendMessageTelegram,
                monitorTelegramProvider: monitor_js_4.monitorTelegramProvider,
                messageActions: telegram_js_1.telegramMessageActions,
            },
            signal: {
                probeSignal: probe_js_4.probeSignal,
                sendMessageSignal: send_js_4.sendMessageSignal,
            ...
            line: {
                ...
                probeLineBot: probe_js_3.probeLineBot,
                sendMessageLine: send_js_3.sendMessageLine,
                pushMessageLine: send_js_3.pushMessageLine,
                pushMessagesLine: send_js_3.pushMessagesLine,
                pushFlexMessage: send_js_3.pushFlexMessage,
                pushTemplateMessage: send_js_3.pushTemplateMessage,
                pushLocationMessage: send_js_3.pushLocationMessage,
                pushTextMessageWithQuickReplies: send_js_3.pushTextMessageWithQuickReplies,
                createQuickReplyItems: send_js_3.createQuickReplyItems,
                buildTemplateMessageFromPayload: template_messages_js_1.buildTemplateMessageFromPayload,
                monitorLineProvider: monitor_js_3.monitorLineProvider,
            },
        },
        logging: {
