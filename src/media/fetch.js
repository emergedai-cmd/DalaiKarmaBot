...
function fetchRemoteMedia(options) {
    return __awaiter(this, void 0, void 0, function () {
        var url, fetchImpl, filePathHint, maxBytes, maxRedirects, ssrfPolicy, lookupFn, res, finalUrl, release, result, err_1, statusText, redirected, detail, snippet, contentLength, length_1, buffer, _a, _b, _c, fileNameFromUrl, parsed, base, headerFileName, fileName, filePathForMime, contentType, ext;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    url = options.url, fetchImpl = options.fetchImpl, filePathHint = options.filePathHint, maxBytes = options.maxBytes, maxRedirects = options.maxRedirects, ssrfPolicy = options.ssrfPolicy, lookupFn = options.lookupFn;
                    finalUrl = url;
                    release = null;
                    _d.label = 1;
                case 1:
                ...
                case 4:
                    ...
                    redirected = finalUrl !== url ? " (redirected to ".concat(finalUrl, ")") : "";
                ...
                case 12:
                    ...
                    filePathForMime = headerFileName && node_path_1.default.extname(headerFileName) ? headerFileName : (filePathHint !== null && filePathHint !== void 0 ? filePathHint : finalUrl);
