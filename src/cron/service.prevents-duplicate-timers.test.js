...
(0, vitest_1.describe)("CronService", function () {
    ...
    (0, vitest_1.it)("avoids duplicate runs when two services share a store", function () { return __awaiter(void 0, void 0, void 0, function () {
        var store, enqueueSystemEvent, requestHeartbeatNow, runIsolatedAgentJob, cronA, atMs, cronB;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    cronA = new service_js_1.CronService({
                    ...
                    return [4 /*yield*/, cronA.start()];
                case 2:
                    _a.sent();
                    atMs = Date.parse("2025-12-13T00:00:01.000Z");
                    return [4 /*yield*/, cronA.add({
                ...
                case 3:
                    _a.sent();
                    cronB = new service_js_1.CronService({
                        storePath: store.storePath,
                        cronEnabled: true,
                        log: noopLogger,
                        enqueueSystemEvent: enqueueSystemEvent,
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, cronA.status()];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, cronB.status()];
                case 7:
                    _a.sent();
                    (0, vitest_1.expect)(enqueueSystemEvent).toHaveBeenCalledTimes(1);
                    (0, vitest_1.expect)(requestHeartbeatNow).toHaveBeenCalledTimes(1);
                    cronA.stop();
                    cronB.stop();
