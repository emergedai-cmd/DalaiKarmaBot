...
(0, vitest_1.describe)("runCronIsolatedAgentTurn", function () {
    ...
    (0, vitest_1.it)("delivers when response has HEARTBEAT_OK but includes media", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    (0, vitest_1.expect)(deps.sendMessageTelegram).toHaveBeenCalledWith("123", "HEARTBEAT_OK", vitest_1.expect.objectContaining({ mediaUrl: "https://example.com/img.png" }));
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
    ...
    (0, vitest_1.it)("delivers when heartbeat ack padding exceeds configured limit", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempHome(function (home) { return __awaiter(void 0, void 0, void 0, function () {
                        var storePath, deps, cfg, res;
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    cfg = makeCfg(home, storePath);
                                    cfg.agents = __assign(__assign({}, cfg.agents), { defaults: __assign(__assign({}, (_a = cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults), { heartbeat: { ackMaxChars: 0 } }) });
                                    return [4 /*yield*/, (0, isolated_agent_js_1.runCronIsolatedAgentTurn)({
                                            cfg: cfg,
                                            deps: deps,
                                            job: makeJob({
